...
export const getCurrentStructure_autres_structures = () => (dispatch) => {
	dispatch(setStructureLoading())
	axios.get('/api/annuaire/hautsdeseine/autres_structures').then((res) =>
		dispatch({
...
export const getCurrentStructure_id_autres_structures = (id) => (dispatch) => {
	dispatch(setStructureLoading())
	axios
		.get(`/api/annuaire/hautsdeseine/autres_structures/${id}`)
		.then((res) =>
			dispatch({
				type: GET_STRUCTURE_AUTRES_STRUCTURES,
				payload: res.data
...
export const deleteStructure_id_autres_structures = (id) => (dispatch) => {
	axios
		.delete(`/api/annuaire/hautsdeseine/autres_structures/${id}`)
		.then((res) =>
			dispatch({
...
export const updateStructure_autres_structures = (id, Data) => (dispatch) => {
	axios.put(`/api/annuaire/hautsdeseine/autres_structures/${id}`, Data).then((res) => res.data).catch((err) =>
		dispatch({
			type: GET_ERRORS,
			payload: {}
		})
...
export const post_autres_structures = (Data, history) => (dispatch) => {
	axios
		.post('/api/annuaire/hautsdeseine/autres_structures', Data)
		.then((res) => history.push('/admin/hautdeseine/autres_structures'))
		.catch((err) =>
			dispatch({
				type: GET_ERRORS,
				payload: {}
...
export const getCurrentStructure_autres = () => (dispatch) => {
	dispatch(setStructureLoading())
	axios.get('/api/annuaire/hautsdeseine/autres').then((res) =>
		dispatch({
...
export const getCurrentStructure_id_autres = (id) => (dispatch) => {
	dispatch(setStructureLoading())
	axios
		.get(`/api/annuaire/hautsdeseine/autres/${id}`)
		.then((res) =>
			dispatch({
				type: GET_STRUCTURE_AUTRES,
				payload: res.data
...
export const deleteStructure_id_autres = (id) => (dispatch) => {
	axios
		.delete(`/api/annuaire/hautsdeseine/autres/${id}`)
		.then((res) =>
			dispatch({
...
export const updateStructure_autres = (id, Data) => (dispatch) => {
	axios.put(`/api/annuaire/hautsdeseine/autres/${id}`, Data).then((res) => res.data).catch((err) =>
		dispatch({
			type: GET_ERRORS,
			payload: {}
		})
...
export const post_autres = (Data, history) => (dispatch) => {
	axios
		.post('/api/annuaire/hautsdeseine/autres', Data)
		.then((res) => history.push('/admin/hautdeseine/autres'))
		.catch((err) =>
			dispatch({
				type: GET_ERRORS,
				payload: {}
