...
export const postHAD = (Data, history) => (dispatch) => {
	axios
		...
		.then((res) => history.push('/admin/essonne/HAD'))
		.catch((err) =>
			dispatch({
				type: GET_ERRORS,
				payload: {}
...
export const getCurrentStructureSOINS = () => (dispatch) => {
	dispatch(setStructureLoading())
	axios.get('/api/annuaire/essonne/essonne/structure').then((res) =>
		dispatch({
...
export const getCurrentStructure_idSOINS = (id) => (dispatch) => {
	dispatch(setStructureLoading())
	axios
		.get(`/api/annuaire/essonne/essonne/structure/${id}`)
		.then((res) =>
			dispatch({
				type: GET_STRUCTURESOINS,
				payload: res.data
...
export const deleteStructure_idSOINS = (id) => (dispatch) => {
	axios
		.delete(`/api/annuaire/essonne/essonne/structure/${id}`)
		.then((res) =>
			dispatch({
...
export const updateStructureSOINS = (id, Data) => (dispatch) => {
	axios.put(`/api/annuaire/essonne/essonne/structure/${id}`, Data).then((res) => res.data).catch((err) =>
		dispatch({
			type: GET_ERRORS,
			payload: {}
		})
...
export const postSOINS = (Data, history) => (dispatch) => {
	axios
		.post('/api/annuaire/essonne/essonne/structure', Data)
