...
export const getCurrentStructure_autres_structures = () => (dispatch) => {
	dispatch(setStructureLoading())
	axios.get('/api/annuaire/yvelines/autres_structures').then((res) =>
		dispatch({
...
export const getCurrentStructure_id_autres_structures = (id) => (dispatch) => {
	dispatch(setStructureLoading())
	axios
		.get(`/api/annuaire/yvelines/autres_structures/${id}`)
		.then((res) =>
			dispatch({
				type: GET_STRUCTURE_AUTRES_STRUCTURES,
				payload: res.data
...
export const deleteStructure_id_autres_structures = (id) => (dispatch) => {
	axios
		.delete(`/api/annuaire/yvelines/autres_structures/${id}`)
		.then((res) =>
			dispatch({
...
export const updateStructure_autres_structures = (id, Data) => (dispatch) => {
	axios.put(`/api/annuaire/yvelines/autres_structures/${id}`, Data).then((res) => res.data).catch((err) =>
		dispatch({
			type: GET_ERRORS,
			payload: {}
		})
...
export const post_autres_structures = (Data, history) => (dispatch) => {
	axios
		.post('/api/annuaire/yvelines/autres_structures', Data)
...
export const getCurrentStructure_autres = () => (dispatch) => {
	dispatch(setStructureLoading())
	axios.get('/api/annuaire/yvelines/autres').then((res) =>
		dispatch({
...
export const getCurrentStructure_id_autres = (id) => (dispatch) => {
	dispatch(setStructureLoading())
	axios
		.get(`/api/annuaire/yvelines/autres/${id}`)
		.then((res) =>
			dispatch({
				type: GET_STRUCTURE_AUTRES,
				payload: res.data
...
export const deleteStructure_id_autres = (id) => (dispatch) => {
	axios
		.delete(`/api/annuaire/yvelines/autres/${id}`)
		.then((res) =>
			dispatch({
...
export const updateStructure_autres = (id, Data) => (dispatch) => {
	axios.put(`/api/annuaire/yvelines/autres/${id}`, Data).then((res) => res.data).catch((err) =>
		dispatch({
			type: GET_ERRORS,
			payload: {}
		})
...
export const post_autres = (Data, history) => (dispatch) => {
	axios
		.post('/api/annuaire/yvelines/autres', Data)
		.then((res) => history.push('/admin/yvelines/autres'))
		.catch((err) =>
			dispatch({
				type: GET_ERRORS,
				payload: {}
