...
export const postHAD = (Data, history) => (dispatch) => {
	axios
		...
		.then((res) => history.push('/admin/yvelines/HAD'))
		.catch((err) =>
			dispatch({
				type: GET_ERRORS,
				payload: {}
...
export const getCurrentStructureSOINS = () => (dispatch) => {
	dispatch(setStructureLoading())
	axios.get('/api/annuaire/yvelines/yvelines/structure').then((res) =>
		dispatch({
...
export const getCurrentStructure_idSOINS = (id) => (dispatch) => {
	dispatch(setStructureLoading())
	axios
		.get(`/api/annuaire/yvelines/yvelines/structure/${id}`)
		.then((res) =>
			dispatch({
				type: GET_STRUCTURESOINS,
				payload: res.data
...
export const deleteStructure_idSOINS = (id) => (dispatch) => {
	axios
		.delete(`/api/annuaire/yvelines/yvelines/structure/${id}`)
		.then((res) =>
			dispatch({
...
export const updateStructureSOINS = (id, Data) => (dispatch) => {
	axios.put(`/api/annuaire/yvelines/yvelines/structure/${id}`, Data).then((res) => res.data).catch((err) =>
		dispatch({
			type: GET_ERRORS,
			payload: {}
		})
...
export const postSOINS = (Data, history) => (dispatch) => {
	axios
		.post('/api/annuaire/yvelines/yvelines/structure', Data)
