...
class HeaderLinksBis extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			loginModal: true,
...
HeaderLinksBis.defaultProps = {
	hoverColor: 'primary'
}

HeaderLinksBis.propTypes = {
...
export default compose(withStyles(headerLinksStyle))(
	connect(mapStateToProps, { logoutUser, clearCurrentProfile, getCurrentProfile, getCurrentfile })(HeaderLinksBis)
)
