...
import SignUpOpen from 'views/SignupPage/SignUpOpenPage'
...
class HeaderLinksRegister extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			loginModal: true,
...
HeaderLinksRegister.defaultProps = {
	hoverColor: 'primary'
}

HeaderLinksRegister.propTypes = {
