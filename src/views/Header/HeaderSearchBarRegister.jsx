...
// sections CSS
import '../style.css'
import HeaderLinksRegister from 'components/Header/HeaderLinksRegister'

class HeaderSearchBarRegister extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
			...
			<div>
				<div>
					<Header
						...
						links={<HeaderLinksRegister dropdownHoverColor="dark" />}
						fixed
						color="#cc4949"
						changeColorOnScroll={{
							height: 400
...
export default withStyles(presentationStyle)(HeaderSearchBarRegister)
