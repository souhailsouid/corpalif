...
class ModalSearchHautsdeSeine extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			searchModal: true
										...
										<GridContainer>
											...
											>
												<h3 className={classes.title} style={{ marginTop: 0 }}>
													L' offre de soins en Hauts-de-Seine
												</h3>
											</GridItem>
											<div className={classes.container}>
												<GridContainer className={classes.gridContainer}>
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/hautsdeseine/usp">
															<InfoArea
																vertical
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/hautsdeseine/reseaux">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Share}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/hautsdeseine/structure">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
												...
												<GridContainer className={classes.gridContainer}>
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/hautsdeseine/lits">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/hautsdeseine/equipesmobiles">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Group}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/hautsdeseine/association">
															<InfoArea
																vertical
																className={classes.infoArea5}
												...
												<GridContainer className={classes.gridContainer} justify="center">
													...
													>
														<Link to="/annuaire/hautsdeseine/autres_structures">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={SupervisedUserCircle}
													...
													>
														<Link to="/annuaire/hautsdeseine/autres">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={SupervisedUserCircle}
...
ModalSearchHautsdeSeine.propTypes = {
...
export default compose(withStyles(javascriptStyles))(
	connect(mapStateToProps, {
		...
		getCurrentStructure_autres,
		getCurrentStructure_autres_structures
	})(withRouter(ModalSearchHautsdeSeine))
)
