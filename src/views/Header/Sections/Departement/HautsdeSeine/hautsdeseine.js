...
import HeaderSearchBar from 'views/Header/Sections/Departement/HautsdeSeine/HeaderSearchBar'
...
class PresentationAnnuaireHautsdeSeine extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
export default withStyles(presentationStyle)(PresentationAnnuaireHautsdeSeine)
