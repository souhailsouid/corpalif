...
import { getCurrentStructureTEAM } from 'actions/HAUTDESEINEActions'
...
class PresentationHadHautsdeSeine extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les équipes mobiles de soins palliatifs en Hauts-de-Seine {' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationHadHautsdeSeine.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureTEAM, getCurrentStructureTEAMMAPS })(
		withRouter(PresentationHadHautsdeSeine)
	)
)
