...
import { getCurrentStructure_autres_structures } from 'actions/HAUTDESEINEActions'
...
class Presentation_HAUTDESEINE_autres_structures extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les autres_structures de prise en charge en Hauts de Seine
										</h3>
									</div>
								</div>
							</GridItem>
...
Presentation_HAUTDESEINE_autres_structures.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres_structures, getCurrentStructureAutresstructuresMAPS })(
		withRouter(Presentation_HAUTDESEINE_autres_structures)
	)
)
