...
import { getCurrentStructure_autres } from 'actions/HAUTDESEINEActions'
...
class Presentation_HAUTDESEINE_Autres extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Autres associations en Hauts-de-Seine
										</h3>
									</div>
								</div>
							</GridItem>
...
Presentation_HAUTDESEINE_Autres.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres, getCurrentStructureAutresMAPS })(
		withRouter(Presentation_HAUTDESEINE_Autres)
	)
)
