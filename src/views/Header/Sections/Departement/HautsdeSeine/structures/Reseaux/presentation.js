...
import { getCurrentStructureReseaux } from 'actions/HAUTDESEINEActions'
...
class PresentationReseauxHautsdeSeine extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
PresentationReseauxHautsdeSeine.propTypes = {
