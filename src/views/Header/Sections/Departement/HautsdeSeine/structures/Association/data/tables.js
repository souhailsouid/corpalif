						...
						<GridItem xs={12} sm={12} md={12}>
							<Grid item md={3} style={{ textAlign: 'center' }}>
								<div style={{ textAlign: 'center' }}>
									<b>
										<h3 style={{ color: '#337467', marginLeft: 10 }}>{association.name}</h3>
									</b>
								</div>
							</Grid>
							<Grid item md={'auto'} style={{ marginLeft: 20 }}>
								<div style={{ display: 'flex', spaceBetween: 'space-between' }}>
									...
									<h5 style={{ marginLeft: 10 }}>
										{association.rue}
										{association.compl} {association.postcode}
									</h5>
								</div>
							</Grid>
							...
							<Grid item md={2} style={{ marginLeft: 20 }}>
								<div style={{ display: 'flex' }}>
									...
									<h5 style={{ marginLeft: 10 }}> {association.email} </h5>
								</div>
							</Grid>
							<Grid item md={2} style={{ marginLeft: 20 }}>
								<div style={{ display: 'flex' }}>
									<i class="material-icons">call</i>{' '}
									<h5 style={{ marginLeft: 10 }}> {association.phone} </h5>
								</div>
							</Grid>
						</GridItem>
					</GridContainer>
					...
					<GridContainer>
						...
						>
							...
							<Grid item md={4} style={{ marginLeft: 20, textAlign: 'center' }}>
								<div>
									<h5>{association.rue}</h5>

									<h5>{association.compl}</h5>
									<h5>{association.postcode}</h5>
								</div>
							</Grid>
							...
							<Grid item md={4} style={{ marginLeft: 0 }}>
								<div style={{ display: 'flex' }}>
									<h5 style={{ marginLeft: 0 }}> {association.email} </h5>
								</div>
							</Grid>
						</GridItem>
						<br />
