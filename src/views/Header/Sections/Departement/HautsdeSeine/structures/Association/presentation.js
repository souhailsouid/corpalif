...
import { getCurrentStructureAssos } from 'actions/HAUTDESEINEActions'
...
class PresentationAssociationHautsdeSeine extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les associations de bénévoles d'accompagnement en Hauts-de-Seine{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationAssociationHautsdeSeine.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureAssos, getCurrentStructureAssociationMaps })(
		withRouter(PresentationAssociationHautsdeSeine)
	)
)
