...
import HeaderSearchBar from 'views/Header/Sections/Departement/Yvelines/HeaderSearchBar'
...
class PresentationAnnuaireYvelines extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
export default withStyles(presentationStyle)(PresentationAnnuaireYvelines)
