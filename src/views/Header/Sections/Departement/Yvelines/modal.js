...
class ModalSearchYvelines extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			searchModal: true
										...
										<GridContainer>
											...
											<div className={classes.container}>
												<GridContainer className={classes.gridContainer}>
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/yvelines/reseaux">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Share}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/yvelines/structure">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
												...
												<GridContainer className={classes.gridContainer}>
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/yvelines/lits">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/yvelines/equipesmobiles">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Group}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/yvelines/association">
															<InfoArea
																vertical
																className={classes.infoArea5}
												...
												<GridContainer className={classes.gridContainer} justify="center">
													...
													>
														<Link to="/annuaire/yvelines/autres_structures">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={SupervisedUserCircle}
													...
													>
														<Link to="/annuaire/yvelines/autres">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={SupervisedUserCircle}
