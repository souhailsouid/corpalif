...
import { getCurrentStructure } from 'actions/YVELINESActions'
...
class PresentationUspYvelines extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les unités de soins palliatifs en Yvelines{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationUspYvelines.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure, getCurrentStructureMaps })(withRouter(PresentationUspYvelines))
)
