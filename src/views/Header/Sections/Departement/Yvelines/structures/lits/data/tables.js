						...
						<GridItem xs={12} sm={12} md={12}>
							<Grid item md={3} style={{ textAlign: 'center' }}>
								<div style={{ textAlign: 'center' }}>
									<b>
										<h3 style={{ color: '#337467' }}>{lit.name}</h3>
									</b>
								</div>
							</Grid>
							<Grid item md={'auto'} style={{ marginLeft: 20 }}>
								<div style={{ display: 'flex' }}>
									<i class="material-icons">room</i> <h5 style={{ marginLeft: 10 }}>{lit.adresse}</h5>
								</div>
							</Grid>
					...
					<GridContainer>
						...
						>
							...
							<Grid item md={3} style={{ marginLeft: 20 }}>
								<div style={{ display: 'flex' }}>
									<h5 style={{ marginLeft: 10 }}>{lit.adresse}</h5>
								</div>
							</Grid>
							<Grid item md={3} style={{ marginLeft: 20 }}>
								<div style={{ display: 'flex' }}>
							...
							<Grid item md={3} style={{ marginLeft: 20 }}>
								<div style={{ display: 'flex' }}>
									<h5 style={{ marginLeft: 10 }}> {lit.phone} </h5>
								</div>
							</Grid>
						</GridItem>
					</GridContainer>
