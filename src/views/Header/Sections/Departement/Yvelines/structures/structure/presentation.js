...
import { getCurrentStructureHAD } from 'actions/YVELINESActions'
...
class PresentationStructureYvelines extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les structures d'hospitalisations aux domiciles en Yvelines
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationStructureYvelines.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureHAD, getCurrentStructureHADMAPS })(
		withRouter(PresentationStructureYvelines)
	)
)
