...
import { getCurrentStructureTEAM } from 'actions/YVELINESActions'
...
class PresentationHadYvelines extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
PresentationHadYvelines.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureTEAM, getCurrentStructureTEAMMAPS })(
		withRouter(PresentationHadYvelines)
	)
)
