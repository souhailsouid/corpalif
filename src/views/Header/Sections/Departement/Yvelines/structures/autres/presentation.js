...
import { getCurrentStructure_autres } from 'actions/YVELINESActions'
...
class Presentation_YVELINES_Autres extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Autres associations en Yvelines
										</h3>
									</div>
								</div>
							</GridItem>
...
Presentation_YVELINES_Autres.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres, getCurrentStructureAutresMAPS })(
		withRouter(Presentation_YVELINES_Autres)
	)
)
