...
import { getCurrentStructureReseaux } from 'actions/YVELINESActions'
...
class PresentationReseauxYvelines extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
PresentationReseauxYvelines.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureReseaux, getCurrentStructureReseauxMAPS })(
		withRouter(PresentationReseauxYvelines)
	)
)
