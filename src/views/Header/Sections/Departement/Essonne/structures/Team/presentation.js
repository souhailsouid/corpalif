...
import { getCurrentStructureTEAM } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'
import { compose } from 'redux'

class PresentationHadEssonne extends React.Component {
	state = {
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les équipes mobiles en ESSONNE
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationHadEssonne.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureTEAM })(withRouter(PresentationHadEssonne))
)
