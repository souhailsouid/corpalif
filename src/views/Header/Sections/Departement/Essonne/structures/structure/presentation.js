								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les structures d'hospitalisations aux domiciles en Essonne
										</h3>
									</div>
								</div>
							</GridItem>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureHAD, getCurrentStructureHADMAPS })(withRouter(ESSONNETRUCTURES))
)
