...
import { getCurrentStructureHAD } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'
import { compose } from 'redux'

class PresentationStructureEssonne extends React.Component {
	state = {
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les Structures d'hospitalisations à domicile en Essonne
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationStructureEssonne.propTypes = {
...
)(connect(mapStateToProps, { getCurrentStructureHAD })(withRouter(PresentationStructureEssonne)))
