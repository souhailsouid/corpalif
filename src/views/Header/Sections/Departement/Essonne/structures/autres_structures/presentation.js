...
import { getCurrentStructure_autres_structures } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'
import { compose } from 'redux'

class Presentation_ESSONNE_autres_structures extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
Presentation_ESSONNE_autres_structures.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres_structures })(
		withRouter(Presentation_ESSONNE_autres_structures)
	)
)
