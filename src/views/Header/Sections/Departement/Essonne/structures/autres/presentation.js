...
import { getCurrentStructure_autres } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'
import { compose } from 'redux'

class Presentation_ESSONNE_Autres extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
Presentation_ESSONNE_Autres.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres })(withRouter(Presentation_ESSONNE_Autres))
)
