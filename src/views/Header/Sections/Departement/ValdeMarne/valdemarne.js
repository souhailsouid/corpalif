...
import HeaderSearchBar from 'views/Header/Sections/Departement/ValdeMarne/HeaderSearchBar'
...
class PresentationAnnuaireValdeMarne extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
export default withStyles(presentationStyle)(PresentationAnnuaireValdeMarne)
