...
} from 'actions/VALDEMARNEActions'
...
class ModalSearchValdeMarne extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			searchModal: true
										...
										<GridContainer>
											...
											>
												<h3 className={classes.title} style={{ marginTop: 0 }}>
													L' offre de soins en Val-de-Marne
												</h3>
											</GridItem>
											<div className={classes.container}>
												<GridContainer className={classes.gridContainer}>
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/valdemarne/usp">
															<InfoArea
																vertical
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/valdemarne/reseaux">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Share}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/valdemarne/structure">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
												...
												<GridContainer className={classes.gridContainer}>
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/valdemarne/lits">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/valdemarne/equipesmobiles">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Group}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/valdemarne/association">
															<InfoArea
																vertical
																className={classes.infoArea5}
												...
												<GridContainer className={classes.gridContainer} justify="center">
													...
													>
														<Link to="/annuaire/valdemarne/autres_structures">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={SupervisedUserCircle}
													...
													>
														<Link to="/annuaire/valdemarne/autres">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={SupervisedUserCircle}
...
ModalSearchValdeMarne.propTypes = {
...
export default compose(withStyles(javascriptStyles))(
	connect(mapStateToProps, {
		...
		getCurrentStructure_autres,
		getCurrentStructure_autres_structures
	})(withRouter(ModalSearchValdeMarne))
)
