...
class PresentationUspValdeMarne extends React.Component {
	state = {
...
PresentationUspValdeMarne.propTypes = {
...
)(connect(mapStateToProps, { getCurrentStructure })(withRouter(PresentationUspValdeMarne)))
