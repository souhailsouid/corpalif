...
import { getCurrentStructureAssos } from 'actions/VALDEMARNEActions'
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les associations de bénévoles d'accompagnement en Val-de-Marne{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationAssociationValdeMarne.propTypes = {
