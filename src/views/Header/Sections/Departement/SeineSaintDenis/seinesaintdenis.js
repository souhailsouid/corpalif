...
import HeaderSearchBar from 'views/Header/Sections/Departement/SeineSaintDenis/HeaderSearchBar'
...
class PresentationAnnuaireSeineSaintDenis extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
export default withStyles(presentationStyle)(PresentationAnnuaireSeineSaintDenis)
