...
import { getCurrentStructureAssos } from 'actions/SEINESAINTDENISActions'
...
class PresentationAssociationSeineSaintDenis extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les associations de bénévoles d'accompagnement en Seine-Saint-Denis{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationAssociationSeineSaintDenis.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureAssos, getCurrentStructureAssociationMaps })(
		withRouter(PresentationAssociationSeineSaintDenis)
	)
)
