...
import { getCurrentStructureHAD } from 'actions/SEINESAINTDENISActions'
...
class PresentationStructureSeineSaintDenis extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les structures d'hospitalisations aux domicles en Seine Saint Denis{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationStructureSeineSaintDenis.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureHAD, getCurrentStructureHADMAPS })(
		withRouter(PresentationStructureSeineSaintDenis)
	)
)
