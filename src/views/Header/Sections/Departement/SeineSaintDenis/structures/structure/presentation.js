								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les Structures d'hospitalisations à domicile en Seine Saint Denis
										</h3>
									</div>
								</div>
							</GridItem>
...
)(connect(mapStateToProps, { getCurrentStructureHAD })(withRouter(PresentationStructureSeineSaintDenis)))
