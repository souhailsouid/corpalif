...
import { getCurrentStructureReseaux } from 'actions/SEINESAINTDENISActions'
import { connect } from 'react-redux'
import { compose } from 'redux'

class PresentationReseauxSeineSaintDenis extends React.Component {
	state = {
...
PresentationReseauxSeineSaintDenis.propTypes = {
...
)(connect(mapStateToProps, { getCurrentStructureReseaux })(withRouter(PresentationReseauxSeineSaintDenis)))
