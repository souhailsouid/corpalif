...
import HeaderSearchBar from 'views/Header/Sections/Departement/SeineetMarne/HeaderSearchBar'
...
class PresentationAnnuaireSeineetMarne extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
export default withStyles(presentationStyle)(PresentationAnnuaireSeineetMarne)
