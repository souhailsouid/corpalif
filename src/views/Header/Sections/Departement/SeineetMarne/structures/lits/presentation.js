...
import { getCurrentStructureLITS } from 'actions/SEINEETMARNEActions'
...
class PresentationLitsSeineetMarne extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les lits identifiés de soins palliatifs en Seine-et-Marne{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationLitsSeineetMarne.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureLITS, getCurrentStructureLITSMAPS })(
		withRouter(PresentationLitsSeineetMarne)
	)
)
