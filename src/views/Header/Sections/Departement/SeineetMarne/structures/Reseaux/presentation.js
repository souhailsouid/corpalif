...
import { getCurrentStructureReseaux } from 'actions/SEINEETMARNEActions'
...
class PresentationReseauxSeineetMarne extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
PresentationReseauxSeineetMarne.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureReseaux, getCurrentStructureReseauxMAPS })(
		withRouter(PresentationReseauxSeineetMarne)
	)
)
