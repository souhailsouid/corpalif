...
import { getCurrentStructureAssos } from 'actions/SEINEETMARNEActions'
...
class PresentationAssociationSeineetMarne extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les associations de bénévoles d'accompagnement en Seine-et-Marne{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationAssociationSeineetMarne.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	...
	})(withRouter(PresentationAssociationSeineetMarne))
)
