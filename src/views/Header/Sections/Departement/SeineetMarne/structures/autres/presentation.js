...
import { getCurrentStructure_autres } from 'actions/SEINEETMARNEActions'
import { connect } from 'react-redux'
import { compose } from 'redux'

class Presentation_SEINEETMARNE_Autres extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
Presentation_SEINEETMARNE_Autres.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres })(withRouter(Presentation_SEINEETMARNE_Autres))
)
