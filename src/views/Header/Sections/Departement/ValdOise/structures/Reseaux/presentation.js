...
import { getCurrentStructureReseaux } from 'actions/VALDOISEActions'
...
class PresentationReseauxValdOise extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
PresentationReseauxValdOise.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureReseaux, getCurrentStructureReseauxMAPS })(
		withRouter(PresentationReseauxValdOise)
	)
)
