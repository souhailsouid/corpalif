...
import { getCurrentStructureLITS } from 'actions/VALDOISEActions'
...
class PresentationLitsValdOise extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les lits identifiés de soins palliatifs en Val-d'Oise{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationLitsValdOise.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureLITS, getCurrentStructureLITSMAPS })(
		withRouter(PresentationLitsValdOise)
	)
)
