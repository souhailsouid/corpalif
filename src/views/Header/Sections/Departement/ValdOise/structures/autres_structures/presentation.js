...
import { getCurrentStructure_autres_structures } from 'actions/VALDOISEActions'
...
class Presentation_VALDOISE_autres_structures extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Autres structures de prise en charge en Val d'Oise
										</h3>
									</div>
								</div>
							</GridItem>
...
Presentation_VALDOISE_autres_structures.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres_structures, getCurrentStructureAutresstructuresMAPS })(
		withRouter(Presentation_VALDOISE_autres_structures)
	)
)
