...
import { getCurrentStructureTEAM } from 'actions/VALDOISEActions'
...
class PresentationHadValdOise extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les équipes mobiles de soins palliatifs en Val-d'Oise{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationHadValdOise.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureTEAM, getCurrentStructureTEAMMAPS })(
		withRouter(PresentationHadValdOise)
	)
)
