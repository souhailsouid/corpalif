...
import { getCurrentStructureAssos } from 'actions/VALDOISEActions'
...
class PresentationAssociationValdOise extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
PresentationAssociationValdOise.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureAssos, getCurrentStructureAssociationMaps })(
		withRouter(PresentationAssociationValdOise)
	)
)
