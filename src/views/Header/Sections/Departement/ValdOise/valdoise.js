...
import HeaderSearchBar from 'views/Header/Sections/Departement/ValdOise/HeaderSearchBar'
...
class PresentationAnnuaireValdOise extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
export default withStyles(presentationStyle)(PresentationAnnuaireValdOise)
