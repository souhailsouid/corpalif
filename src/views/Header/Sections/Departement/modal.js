...
import * as SEINESAINTDENISActions from 'actions/SEINESAINTDENISActions'
...
class ModalSearchSeineSaintDenis extends React.Component {
	...
	componentDidMount() {
		this.props.SEINESAINTDENISActions()
	}
										...
										<GridContainer>
											...
											>
												<h3 className={classes.title} style={{ marginTop: 0 }}>
													L' offre de soins ${annuaire.departement}
												</h3>
											</GridItem>
											<div className={classes.container}>
												<GridContainer className={classes.gridContainer}>
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to={`/annuaire/${annuaire.departement}/usp`}>
															<InfoArea
																vertical
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to={`/annuaire/${annuaire.departement}/reseaux`}>
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Share}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to={`/annuaire/${annuaire.departement}/structure`}>
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
												...
												<GridContainer className={classes.gridContainer}>
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to={`/annuaire/${annuaire.departement}/lits`}>
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to={`/annuaire/${annuaire.departement}/equipesmobiles`}>
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Group}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to={`/annuaire/${annuaire.departement}/association`}>
															<InfoArea
																vertical
																className={classes.infoArea5}
												...
												<GridContainer className={classes.gridContainer} justify="center">
													...
													>
														<Link
															to={`/annuaire/${annuaire.departement}/autres_structures`}
														>
															<InfoArea
																vertical
																className={classes.infoArea5}
													...
													>
														<Link to={`/annuaire/${annuaire.departement}/autres`}>
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={SupervisedUserCircle}
...
ModalSearchSeineSaintDenis.propTypes = {
	SEINESAINTDENISActions: PropTypes.func.isRequired,
