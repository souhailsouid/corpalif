...
import { getCurrentStructureHAD } from 'actions/annuaireActions'
...
class PresentationStructureParis extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les structures d'hospitalisations aux domiciles sur Paris{' '}
										</h3>
									</div>
								</div>
							</GridItem>
...
PresentationStructureParis.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureHAD, getCurrentStructureHADMAPS })(
		withRouter(PresentationStructureParis)
	)
)
