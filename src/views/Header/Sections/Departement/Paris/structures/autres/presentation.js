...
import { getCurrentStructure_autres } from 'actions/annuaireActions'
...
class Presentation_PARIS_Autres extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
Presentation_PARIS_Autres.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres, getCurrentStructureAutresMAPS })(
		withRouter(Presentation_PARIS_Autres)
	)
)
