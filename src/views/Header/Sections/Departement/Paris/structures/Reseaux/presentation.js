...
import { getCurrentStructureReseaux } from 'actions/annuaireActions'
import { connect } from 'react-redux'
import { compose } from 'redux'
import { Map as LeafletMap, Marker, Popup, TileLayer } from 'react-leaflet'
import { getCurrentStructureReseauxMAPS } from 'actions/maps/mapsParisActions'
...
class PresentationReseauxParis extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
PresentationReseauxParis.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureReseaux, getCurrentStructureReseauxMAPS })(
		withRouter(PresentationReseauxParis)
	)
)
