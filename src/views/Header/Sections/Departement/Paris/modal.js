...
class ModalSearchParis extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			searchModal: true
										...
										<GridContainer>
											...
											>
												<h3 className={classes.title} style={{ marginTop: 0 }}>
													L' offre de soins à Paris
												</h3>
											</GridItem>
											<div className={classes.container}>
												<GridContainer className={classes.gridContainer}>
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/paris/usp">
															<InfoArea
																vertical
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/paris/reseaux">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Share}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/paris/structure">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Home}
												...
												<GridContainer className={classes.gridContainer}>
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/paris/equipesmobiles">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={Group}
													...
													<GridItem xs={12} sm={4} className={classes.gridItem}>
														<Link to="/annuaire/paris/association">
															<InfoArea
																vertical
																className={classes.infoArea5}
												...
												<GridContainer className={classes.gridContainer} justify="center">
													...
													>
														<Link to="/annuaire/paris/autres_structures">
															<InfoArea
																vertical
																className={classes.infoArea5}
																icon={SupervisedUserCircle}
