...
import HeaderSearchBar from 'views/Header/Sections/Departement/Paris/HeaderSearchBar'
...
class PresentationAnnuaireParis extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
export default withStyles(presentationStyle)(PresentationAnnuaireParis)
