...
// sections CSS
import '../style.css'
import HeaderLinksBis from 'components/Header/HeaderLinksBis'

class HeaderSearchBarBis extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
			...
			<div>
				<div>
					<Header
						...
						links={<HeaderLinksBis dropdownHoverColor="dark" />}
						fixed
						color="#cc4949"
						changeColorOnScroll={{
							height: 400
...
export default withStyles(presentationStyle)(HeaderSearchBarBis)
