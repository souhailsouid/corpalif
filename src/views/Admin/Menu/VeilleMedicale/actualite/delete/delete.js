...
import { delete_Actualite } from 'actions/menu/veillemedicale/actualiteActions'
...
Modal.propTypes = {
	...
	delete_Actualite: PropTypes.func.isRequired,
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { delete_Actualite })(withRouter(Modal))
)
