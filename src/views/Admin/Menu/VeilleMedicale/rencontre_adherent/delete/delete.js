...
import { delete_Rencontre_inscrit } from 'actions/menu/veillemedicale/rencontre_adherentActions'
...
class Modal extends React.Component {
	...
	onDeleteClick() {
		this.props.delete_Rencontre_inscrit(this.props.match.params.id)
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() =>
							this.handleClose(window.location.replace('/#/admin/menu/veillemedicale/adherentsinfo/'))}
...
Modal.propTypes = {
	...
	delete_Rencontre_inscrit: PropTypes.func.isRequired,
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { delete_Rencontre_inscrit })(withRouter(Modal))
)
