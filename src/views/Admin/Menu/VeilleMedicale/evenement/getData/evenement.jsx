		...
		<Card plain blog className={classes.card}>
			<GridContainer>
				...
				<GridItem xs={12} sm={8} md={8}>
					...
					<h3 className={classes.cardTitle}>{evenement.title}</h3>
					...
					<Grid item xs={4} style={{ textAlign: 'right' }}>
						<Link to={`/admin/menu/veillemedicale/evenement/get/${evenement._id}`}>{get}</Link>
						<Link to={`/admin/menu/veillemedicale/evenement/update/${evenement._id}`}>{update}</Link>
						<Link to={`/admin/menu/veillemedicale/evenement/delete/${evenement._id}`}>{deleteButton}</Link>
					</Grid>
				</GridItem>
			</GridContainer>
		</Card>
...
export default withStyles(blogsStyle)(Evenement)
