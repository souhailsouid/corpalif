...
import { delete_Evenement } from 'actions/menu/veillemedicale/evenementActions'
...
class Modal extends React.Component {
	...
	onDeleteClick() {
		this.props.delete_Evenement(this.props.match.params.id)
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() =>
							this.handleClose(window.location.replace('/#/admin/menu/veillemedicale/evenement/'))}
...
Modal.propTypes = {
	...
	delete_Evenement: PropTypes.func.isRequired,
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { delete_Evenement })(withRouter(Modal))
)
