...
import { delete_Rencontre_inscrit } from 'actions/menu/veillemedicale/rencontre_inscritActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() =>
							this.handleClose(window.location.replace('/admin/menu/veillemedicale/privateinfo/'))}
