...
import { delete_recommandation } from 'actions/menu/veillemedicale/recommandationActions'
...
class Modal extends React.Component {
	...
	onDeleteClick() {
		this.props.delete_recommandation(this.props.match.params.id)
...
Modal.propTypes = {
	...
	delete_recommandation: PropTypes.func.isRequired,
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { delete_recommandation })(withRouter(Modal))
)
