...
class Modal extends React.Component {
	...
	componentWillReceiveProps(nextProps) {
		if (nextProps.recommandation.recommandation) {
			const recommandation = nextProps.recommandation.recommandation

			// If recommandation field doesnt exist, make empty string
			recommandation.theme = !isEmpty(recommandation.theme) ? recommandation.theme : ''
