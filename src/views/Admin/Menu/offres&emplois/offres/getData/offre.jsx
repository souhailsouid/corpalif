...
const Offreemploi = ({ offreemploi, classes }) => (
	<div>
			...
			<GridContainer>
				...
				<GridItem xs={12} sm={8} md={8}>
					...
					<Grid item xs={4} style={{ textAlign: 'right' }}>
						<Link to={`/admin/menu/offres-emplois/get/${offreemploi._id}`}>{get}</Link>
						<Link to={`/admin/menu/offres-emplois/update/${offreemploi._id}`}>{update}</Link>
						<Link to={`/admin/menu/offres-emplois/delete/${offreemploi._id}`}>{deleteButton}</Link>
					</Grid>
				</GridItem>
			</GridContainer>
		</Card>
...
export default withStyles(blogsStyle)(Offreemploi)
