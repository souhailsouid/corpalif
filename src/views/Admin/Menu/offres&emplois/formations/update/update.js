...
class Modal extends React.Component {
	...
	componentWillReceiveProps(nextProps) {
		if (nextProps.formation.formation) {
			const formation = nextProps.formation.formation

			// If formation field doesnt exist, make empty string
			formation.theme = !isEmpty(formation.theme) ? formation.theme : ''
			formation.title = !isEmpty(formation.title) ? formation.title : ''
			formation.message = !isEmpty(formation.message) ? formation.message : ''
			formation.fileName = !isEmpty(formation.fileName) ? formation.fileName : ''
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/menu/formations/'))}
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { getCurrentFormation_id })(withRouter(Modal))
)
