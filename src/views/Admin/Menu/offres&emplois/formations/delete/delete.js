...
import { delete_Formation } from 'actions/menu/formations/formationsActions'
...
Modal.propTypes = {
	...
	delete_Formation: PropTypes.func.isRequired,
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { delete_Formation })(withRouter(Modal))
)
