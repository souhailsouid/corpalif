...
class SoinsPalliatifPage extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
												...
												<GridItem xs={12} sm={12} md={7} className={classes.gridItem}>
													...
													<GridContainer className={classes.collections}>
														<GridItem xs={12} sm={12} md={6}>
															<Link to="/admin/menu/soinspalliatifs/accompagnement/">
																<Card
																	background
																	style={{
														...
														<GridItem xs={12} sm={12} md={6}>
															<Link to="/admin/menu/soinspalliatifs/demarche/">
																<Card
																	background
																	style={{
																		backgroundImage: 'url(' + paris + ')'
														...
														<GridItem xs={12} sm={12} md={6}>
															<Link to="/admin/menu/soinspalliatifs/legislation/">
																<Card
																	background
																	style={{
																		backgroundImage: 'url(' + paris + ')'
...
export default withStyles(profilePageStyle)(SoinsPalliatifPage)
