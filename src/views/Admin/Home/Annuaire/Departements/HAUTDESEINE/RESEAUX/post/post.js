...
import { postReseaux } from 'actions/HAUTDESEINEActions'

class PostHAUTDESEINERESEAUX extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINERESEAUX.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostHAUTDESEINERESEAUX))
)
