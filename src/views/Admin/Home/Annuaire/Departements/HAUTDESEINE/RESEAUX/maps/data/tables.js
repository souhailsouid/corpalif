		...
		<GridContainer>
			...
			>
				...
				<Grid item xs={3} style={{ textAlign: 'right' }}>
					<Link to={`/admin/update/HAUTDESEINE/maps/reseaux/${mapreseaux._id}`}>{update}</Link>
					<Link to={`/admin/delete/HAUTDESEINE/maps/reseaux/${mapreseaux._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
