...
import { deleteStructure_idReseaux } from 'actions/maps/mapsHautsdeSeineActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/HAUTDESEINE/reseaux'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/HAUTDESEINE/reseaux'))}
								color="secondary"
							>
								Annuler
							</Button>
