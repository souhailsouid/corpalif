...
import { getCurrentStructureReseaux, deleteStructure_idReseaux } from 'actions/HAUTDESEINEActions'
import { connect } from 'react-redux'
import { compose } from 'redux'
import { Map as LeafletMap, Marker, Popup, TileLayer } from 'react-leaflet'
import { getCurrentStructureReseauxMAPS } from 'actions/maps/mapsHautsdeSeineActions'
...
class HAUTDESEINERESEAUX extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
					...
					<div className={classes.container}>
						...
						<GridItem xs={12} sm={10} md={12}>
							...
							>
								...
								<Link to="/admin/post/HAUTDESEINE/reseaux">
...
<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/HAUTDESEINE/maps/RESEAUX">
									<Button round variant="fab" color="green" aria-label="Add">
										<AddIcon />
									</Button>
								</Link>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureReseaux, deleteStructure_idReseaux, getCurrentStructureReseauxMAPS })(withRouter(HAUTDESEINERESEAUX))
)
