...
import { updateStructureAutres, getCurrentStructure_idAutres } from 'actions/maps/mapsHautsdeSeineActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/HAUTDESEINE/autres')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/HAUTDESEINE/autres'))}
