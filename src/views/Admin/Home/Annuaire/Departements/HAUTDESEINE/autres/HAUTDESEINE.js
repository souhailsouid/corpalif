...
import { getCurrentStructure_autres, deleteStructure_id_autres } from 'actions/HAUTDESEINEActions'
import { connect } from 'react-redux'
import { compose } from 'redux'
import { Map as LeafletMap, Marker, Popup, TileLayer } from 'react-leaflet'
import { getCurrentStructureAutresMAPS } from 'actions/maps/mapsHautsdeSeineActions'
...
class HAUTDESEINEautres extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
...
this.props.getCurrentStructureAutresMAPS()
					...
					<div className={classes.container}>
						...
						<GridItem xs={12} sm={10} md={12}>
							<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/HAUTDESEINE/autres">
	...
	<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/HAUTDESEINE/maps/autres">
									<Button round variant="fab" color="green" aria-label="Add">
										<AddIcon />
									</Button>
								</Link>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres, deleteStructure_id_autres , getCurrentStructureAutresMAPS})(withRouter(HAUTDESEINEautres))
)
