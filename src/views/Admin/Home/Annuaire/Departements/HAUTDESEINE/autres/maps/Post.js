...
import { postAutres } from 'actions/maps/mapsHautsdeSeineActions'

class PostHAUTDESEINEAUTRESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINEAUTRESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAutres })(withRouter(PostHAUTDESEINEAUTRESMaps))
)
