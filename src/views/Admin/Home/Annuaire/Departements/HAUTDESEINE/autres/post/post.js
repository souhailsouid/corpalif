...
import { post_autres } from 'actions/HAUTDESEINEActions'

class PostHAUTDESEINEautres extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINEautres.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres })(withRouter(PostHAUTDESEINEautres))
)
