...
import { deleteStructure_idTEAM } from 'actions/HAUTDESEINEActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/HAUTDESEINE/equipesmobiles'))}
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { deleteStructure_idTEAM })(withRouter(Modal))
)
