...
import { updateStructureAssosMaps, getCurrentStructure_idAssosMaps } from 'actions/maps/mapsHautsdeSeineActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/HAUTDESEINE/equipesmobiles')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/HAUTDESEINE/equipesmobiles'))}
