		...
		<GridContainer>
			...
			>
				...
				<Grid item xs={3} style={{ textAlign: 'right' }}>
					<Link to={`/admin/update/HAUTDESEINE/maps/equipesmobiles/${mapteam._id}`}>{update}</Link>
					<Link to={`/admin/delete/HAUTDESEINE/maps/equipesmobiles/${mapteam._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
