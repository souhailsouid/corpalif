...
import { postTEAM } from 'actions/maps/mapsHautsdeSeineActions'

class PostHAUTDESEINETEAMMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINETEAMMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostHAUTDESEINETEAMMaps))
)
