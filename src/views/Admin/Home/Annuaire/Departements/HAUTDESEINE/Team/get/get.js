...
import { getCurrentStructure_idTEAM, deleteStructure_idTEAM } from 'actions/HAUTDESEINEActions'
import { connect } from 'react-redux'

class GetHAUTDESEINEHAD extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/HAUTDESEINE/equipesmobiles/${had._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
