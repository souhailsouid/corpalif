...
import { getCurrentStructure_idSOINS, deleteStructure_idSOINS } from 'actions/HAUTDESEINEActions'
import { connect } from 'react-redux'

class GetHAUTDESEINESTRUCTURES extends Component {
	componentDidMount() {
...
GetHAUTDESEINESTRUCTURES.propTypes = {
...
export default connect(mapStateToProps, { getCurrentStructure_idSOINS, deleteStructure_idSOINS })(
	withRouter(GetHAUTDESEINESTRUCTURES)
)
