...
import { updateStructureHAD, getCurrentStructure_idHAD } from 'actions/maps/mapsHautsdeSeineActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/HAUTDESEINE/structures')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/HAUTDESEINE/structures'))}
