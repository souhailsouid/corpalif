...
class PostHAUTDESEINESTRUCTURES extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINESTRUCTURES.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postSOINS })(withRouter(PostHAUTDESEINESTRUCTURES))
)
