...
import { deleteStructure_idHAD } from 'actions/maps/mapsHautsdeSeineActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/HAUTDESEINE/structures'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/HAUTDESEINE/structures'))}
								color="secondary"
							>
								Annuler
							</Button>
