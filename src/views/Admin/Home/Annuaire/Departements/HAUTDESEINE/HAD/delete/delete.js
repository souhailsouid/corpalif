...
import { deleteStructure_idHAD } from 'actions/HAUTDESEINEActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/HAUTDESEINE/had'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/HAUTDESEINE/had'))}
								color="secondary"
							>
								Annuler
							</Button>
