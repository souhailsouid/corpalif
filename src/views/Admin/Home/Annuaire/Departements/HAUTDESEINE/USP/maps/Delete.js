...
import { deleteStructure_id } from 'actions/maps/mapsHautsdeSeineActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/HAUTDESEINE/usp'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/HAUTDESEINE/usp'))}
								color="secondary"
							>
								Annuler
							</Button>
