...
import { post } from 'actions/maps/mapsHautsdeSeineActions'

class PostHAUTDESEINEUSPMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINEUSPMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostHAUTDESEINEUSPMaps))
)
