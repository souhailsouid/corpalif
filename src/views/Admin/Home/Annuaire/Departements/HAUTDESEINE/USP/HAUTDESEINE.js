...
import { getCurrentStructure, deleteStructure_id } from 'actions/HAUTDESEINEActions'
...
class HautsdeSeine extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
					...
					<div className={classes.container}>
						...
						<GridItem xs={12} sm={10} md={12}>
							...
							>
								...
								<Link to="/admin/post/HautdeSeine/usp">
						...
						<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/HautdeSeine/maps/USP">
									<Button round variant="fab" color="green" aria-label="Add">
										<AddIcon />
									</Button>
								</Link>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure, deleteStructure_id, getCurrentStructureMaps })(withRouter(HautsdeSeine))
)
