...
import { updateStructure, getCurrentStructure_id } from 'actions/HAUTDESEINEActions'
...
class Modal extends React.Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.usp.usp) {
			const usp = nextProps.usp.usp

			// If usp field doesnt exist, make empty string
			usp.name = !isEmpty(usp.name) ? usp.name : ''
			usp.email = !isEmpty(usp.email) ? usp.email : ''
			usp.phone = !isEmpty(usp.phone) ? usp.phone : ''
			usp.rue = !isEmpty(usp.rue) ? usp.rue : ''
			usp.compl = !isEmpty(usp.compl) ? usp.compl : ''
			usp.postcode = !isEmpty(usp.postcode) ? usp.postcode : ''
			usp.web = !isEmpty(usp.web) ? usp.web : ''
	...
	onSubmit(e) {
		...
		window.location.replace('/#/admin/hautdeseine/usp')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/#/admin/hautdeseine/usp'))}
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { updateStructure, getCurrentStructure_id })(withRouter(Modal))
)
