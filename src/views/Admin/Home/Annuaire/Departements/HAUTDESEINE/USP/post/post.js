...
import { post } from 'actions/HAUTDESEINEActions'

class PostUSPHAUTDESEINE extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostUSPHAUTDESEINE))
)
