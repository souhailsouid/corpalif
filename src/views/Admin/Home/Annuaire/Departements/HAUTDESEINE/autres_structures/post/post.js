...
import { post_autres_structures } from 'actions/HAUTDESEINEActions'

class PostHAUTDESEINEautres_structures extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINEautres_structures.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres_structures })(withRouter(PostHAUTDESEINEautres_structures))
)
