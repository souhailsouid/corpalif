	...
	<div>
		<GridContainer>
			...
			>
				...
				<Grid item xs={4} style={{ textAlign: 'right' }}>
					<Link to={`/admin/HAUTDESEINE/autres_structures/${autres_structures._id}`}>{get}</Link>
					<Link to={`/admin/update/HAUTDESEINE/autres_structures/${autres_structures._id}`}>{update}</Link>
