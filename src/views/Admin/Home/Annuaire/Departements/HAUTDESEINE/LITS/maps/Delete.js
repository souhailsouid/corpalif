...
import { deleteStructure_idLITS } from 'actions/maps/mapsHautsdeSeineActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/HAUTDESEINE/lits'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/HAUTDESEINE/lits'))}
								color="secondary"
							>
								Annuler
							</Button>
