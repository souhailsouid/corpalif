...
import { postLITS } from 'actions/maps/mapsHautsdeSeineActions'

class PostHAUTDESEINELITSMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINELITSMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostHAUTDESEINELITSMaps))
)
