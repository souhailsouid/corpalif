...
import { postLITS } from 'actions/HAUTDESEINEActions'

class PostHAUTDESEINELITS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostHAUTDESEINELITS))
)
