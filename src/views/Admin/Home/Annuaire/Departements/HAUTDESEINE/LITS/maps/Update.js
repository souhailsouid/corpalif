...
import { updateStructureLITS, getCurrentStructure_idLITS } from 'actions/maps/mapsHautsdeSeineActions'
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/HAUTDESEINE/lits'))}
