...
import { updateStructureAssos, getCurrentStructure_idAssos } from 'actions/HAUTDESEINEActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/admin/HAUTDESEINE/association')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/HAUTDESEINE/association'))}
