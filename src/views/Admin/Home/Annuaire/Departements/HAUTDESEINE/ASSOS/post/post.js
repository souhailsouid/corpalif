...
import { postAssos } from 'actions/HAUTDESEINEActions'

class PostHAUTDESEINEASSOS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostHAUTDESEINEASSOS.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAssos })(withRouter(PostHAUTDESEINEASSOS))
)
