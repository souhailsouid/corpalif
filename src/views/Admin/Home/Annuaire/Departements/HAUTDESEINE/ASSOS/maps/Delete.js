...
import { deleteStructure_idAssosMaps } from 'actions/maps/mapsHautsdeSeineActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/HAUTDESEINE/association'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/HAUTDESEINE/association'))}
								color="secondary"
							>
								Annuler
							</Button>
