...
import { getCurrentStructure_idAssos, deleteStructure_idAssos } from 'actions/HAUTDESEINEActions'
import { connect } from 'react-redux'

class GetHAUTDESEINEASSOS extends Component {
	componentDidMount() {
...
export default connect(mapStateToProps, { getCurrentStructure_idAssos, deleteStructure_idAssos })(
	withRouter(GetHAUTDESEINEASSOS)
)
