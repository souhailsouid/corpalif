...
import { postTEAM } from 'actions/VALDOISEActions'

class PostVALDOISEHAD extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostVALDOISEHAD))
)
