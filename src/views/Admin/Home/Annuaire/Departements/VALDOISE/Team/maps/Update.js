...
import { updateStructureAssosMaps, getCurrentStructure_idAssosMaps } from 'actions/maps/mapsValdOiseActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/VALDOISE/equipesmobiles')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/VALDOISE/equipesmobiles'))}
