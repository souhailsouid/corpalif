...
import { updateStructureTEAM, getCurrentStructure_idTEAM } from 'actions/VALDOISEActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/admin/VALDOISE/had')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/VALDOISE/had'))}
