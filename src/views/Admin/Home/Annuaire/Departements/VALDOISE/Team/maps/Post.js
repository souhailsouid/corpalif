...
import { postTEAM } from 'actions/maps/mapsValdOiseActions'

class PostVALDOISETEAMMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDOISETEAMMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostVALDOISETEAMMaps))
)
