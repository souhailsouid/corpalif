...
import { getCurrentStructure_idTEAM, deleteStructure_idTEAM } from 'actions/VALDOISEActions'
import { connect } from 'react-redux'

class GetVALDOISEHAD extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/VALDOISE/equipesmobiles/${had._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
