...
import { deleteStructure_id } from 'actions/maps/mapsValdOiseActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/VALDOISE/usp'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/VALDOISE/usp'))}
								color="secondary"
							>
								Annuler
							</Button>
