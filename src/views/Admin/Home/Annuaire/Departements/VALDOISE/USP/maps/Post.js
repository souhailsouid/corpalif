...
import { post } from 'actions/maps/mapsValdOiseActions'

class PostVALDOISEUSPMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostVALDOISEUSPMaps))
)
