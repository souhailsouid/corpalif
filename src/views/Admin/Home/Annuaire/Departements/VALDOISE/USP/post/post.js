...
import { post } from 'actions/VALDOISEActions'

class PostUSPVALDOISE extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.auth.usp) {
			const usp = nextProps.auth.usp
...
export default compose(withStyles(presentationStyle))(connect(mapStateTopProps, { post })(withRouter(PostUSPVALDOISE)))
