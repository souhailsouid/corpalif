...
import { post_autres_structures } from 'actions/VALDOISEActions'

class PostVALDOISEautres_structures extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDOISEautres_structures.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres_structures })(withRouter(PostVALDOISEautres_structures))
)
