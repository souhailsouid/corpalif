...
} from 'actions/maps/mapsValdOiseActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/VALDOISE/autres_structures')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/VALDOISE/autres_structures'))}
