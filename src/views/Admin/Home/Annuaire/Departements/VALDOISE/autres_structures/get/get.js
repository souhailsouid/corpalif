...
import { getCurrentStructure_id_autres_structures, deleteStructure_id_autres_structures } from 'actions/VALDOISEActions'
import { connect } from 'react-redux'

class GetVALDOISEautres_structures extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/VALDOISE/autres_structures/${autres_structures._id}`}>
								{deleteButton}
							</Link>
						</Grid>
					</GridItem>
...
GetVALDOISEautres_structures.propTypes = {
...
})(withRouter(GetVALDOISEautres_structures))
