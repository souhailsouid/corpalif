...
import { getCurrentStructureSOINS, deleteStructure_idSOINS } from 'actions/VALDOISEActions'
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureSOINS, deleteStructure_idSOINS })(withRouter(VALDOISETRUCTURES))
)
