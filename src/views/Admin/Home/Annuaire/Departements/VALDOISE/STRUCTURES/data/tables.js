	...
	<div>
		<GridContainer>
			...
			>
				...
				<Grid item xs={4} style={{ textAlign: 'right' }}>
					<Link to={`/admin/VALDOISEE/structures/${soin._id}`}>{get}</Link>
					<Link to={`/admin/update/VALDOISEE/structures/${soin._id}`}>{update}</Link>
					<Link to={`/admin/delete/VALDOISEE/structures/${soin._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
