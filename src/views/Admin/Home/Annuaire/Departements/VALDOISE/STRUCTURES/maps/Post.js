...
import { postAssos } from 'actions/maps/mapsValdOiseActions'

class PostVALDOISESTRUCTURESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDOISESTRUCTURESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postHAD })(withRouter(PostVALDOISESTRUCTURESMaps))
)
