...
import { getCurrentStructure_idSOINS, deleteStructure_idSOINS } from 'actions/VALDOISEActions'
import { connect } from 'react-redux'

class GetVALDOISESTRUCTURES extends Component {
	componentDidMount() {
...
GetVALDOISESTRUCTURES.propTypes = {
...
export default connect(mapStateToProps, { getCurrentStructure_idSOINS, deleteStructure_idSOINS })(
	withRouter(GetVALDOISESTRUCTURES)
)
