...
import { deleteStructure_idHAD } from 'actions/VALDOISEActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/VALDOISE/had'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/VALDOISE/had'))}
								color="secondary"
							>
								Annuler
							</Button>
