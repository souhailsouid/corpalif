...
import { updateStructureLITS, getCurrentStructure_idLITS } from 'actions/maps/mapsValdOiseActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/VALDOISE/lits')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/VALDOISE/lits'))}
