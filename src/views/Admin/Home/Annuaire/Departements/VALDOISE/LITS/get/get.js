...
import { getCurrentStructure_idLITS, deleteStructure_idLITS } from 'actions/VALDOISEActions'
import { connect } from 'react-redux'

class GetVALDOISELITS extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/VALDOISE/lits/${lit._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
