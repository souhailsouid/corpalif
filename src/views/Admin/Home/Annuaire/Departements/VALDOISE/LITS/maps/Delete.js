...
import { deleteStructure_idLITS } from 'actions/maps/mapsValdOiseActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/VALDOISE/lits'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/VALDOISE/lits'))}
								color="secondary"
							>
								Annuler
							</Button>
