...
import { postLITS } from 'actions/VALDOISEActions'

class PostVALDOISELITS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostVALDOISELITS))
)
