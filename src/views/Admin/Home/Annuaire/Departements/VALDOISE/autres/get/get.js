...
import { getCurrentStructure_id_autres, deleteStructure_id_autres } from 'actions/VALDOISEActions'
import { connect } from 'react-redux'

class GetVALDOISEautres extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/VALDOISE/autres/${autres._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
