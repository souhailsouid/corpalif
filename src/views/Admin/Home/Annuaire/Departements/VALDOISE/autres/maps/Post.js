...
import { postAutres } from 'actions/maps/mapsValdOiseActions'

class PostVALDOISEAUTRESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDOISEAUTRESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAutres })(withRouter(PostVALDOISEAUTRESMaps))
)
