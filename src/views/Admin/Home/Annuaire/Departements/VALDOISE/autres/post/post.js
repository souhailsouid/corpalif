...
import { post_autres } from 'actions/VALDOISEActions'

class PostVALDOISEautres extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres })(withRouter(PostVALDOISEautres))
)
