		...
		<GridContainer>
			...
			>
				...
				<Grid item xs={3} style={{ textAlign: 'right' }}>
					<Link to={`/admin/update/VALDOISE/maps/association/${mapassociation._id}`}>{update}</Link>
					<Link to={`/admin/delete/VALDOISE/maps/association/${mapassociation._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
