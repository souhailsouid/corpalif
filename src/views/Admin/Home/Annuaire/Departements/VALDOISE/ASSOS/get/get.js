...
import { getCurrentStructure_idAssos, deleteStructure_idAssos } from 'actions/VALDOISEActions'
import { connect } from 'react-redux'

class GetVALDOISEASSOS extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/VALDOISE/association/${association._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
