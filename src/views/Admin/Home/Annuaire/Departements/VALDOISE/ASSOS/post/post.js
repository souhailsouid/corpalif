...
import { postAssos } from 'actions/VALDOISEActions'

class PostVALDOISEASSOS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAssos })(withRouter(PostVALDOISEASSOS))
)
