...
import { postReseaux } from 'actions/VALDOISEActions'

class PostVALDOISERESEAUX extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostVALDOISERESEAUX))
)
