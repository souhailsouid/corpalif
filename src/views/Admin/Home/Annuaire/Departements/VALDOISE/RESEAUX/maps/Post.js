...
import { postReseaux } from 'actions/maps/mapsValdOiseActions'

class PostVALDOISERESEAUXMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDOISERESEAUXMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostVALDOISERESEAUXMaps))
)
