...
import { updateStructureReseaux, getCurrentStructure_idReseaux } from 'actions/maps/mapsValdOiseActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/VALDOISE/reseaux')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/VALDOISE/reseaux'))}
