...
import { postTEAM } from 'actions/maps/mapsYvelinesActions'

class PostYVELINESTEAMMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostYVELINESTEAMMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostYVELINESTEAMMaps))
)
