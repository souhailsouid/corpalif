...
import { postTEAM } from 'actions/YVELINESActions'

class PostYVELINESHAD extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostYVELINESHAD))
)
