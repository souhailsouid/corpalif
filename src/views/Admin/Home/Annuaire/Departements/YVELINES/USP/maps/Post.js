...
import { post } from 'actions/maps/mapsYvelinesActions'

class PostYVELINESUSPMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostYVELINESUSPMaps))
)
