...
import { getCurrentStructure, deleteStructure_id } from 'actions/YVELINESActions'
import { connect } from 'react-redux'
import { compose } from 'redux'
import { Map as LeafletMap, Marker, Popup, TileLayer } from 'react-leaflet'
import { getCurrentStructureMaps } from 'actions/maps/mapsYvelinesActions'
...
class YVELINES extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
			...
			<div>
				...
				<div className={classNames(classes.main, classes.mainRaised)}>
					<div className={classes.container}>
						...
						<GridItem xs={12} sm={10} md={12}>
							...
							>
								...
								<Link to="/admin/post/YVELINES/usp">
					...
					<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/YVELINES/maps/usp">
									<Button round variant="fab" color="green" aria-label="Add">
										<AddIcon />
									</Button>
								</Link>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure, deleteStructure_id, getCurrentStructureMaps })(withRouter(YVELINES))
)
