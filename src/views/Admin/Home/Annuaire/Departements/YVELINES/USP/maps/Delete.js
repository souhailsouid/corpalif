...
import { deleteStructure_id } from 'actions/maps/mapsYvelinesActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/YVELINES/usp'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/YVELINES/usp'))}
								color="secondary"
							>
								Annuler
							</Button>
