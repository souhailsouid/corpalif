...
import { deleteStructure_idLITS } from 'actions/maps/mapsYvelinesActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/YVELINES/lits'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/YVELINES/lits'))}
								color="secondary"
							>
								Annuler
							</Button>
