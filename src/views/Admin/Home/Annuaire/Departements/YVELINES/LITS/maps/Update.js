...
import { updateStructureLITS, getCurrentStructure_idLITS } from 'actions/maps/mapsYvelinesActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/YVELINES/lits')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/YVELINES/lits'))}
