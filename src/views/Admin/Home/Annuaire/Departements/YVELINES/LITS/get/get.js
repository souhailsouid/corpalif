...
import { getCurrentStructure_idLITS, deleteStructure_idLITS } from 'actions/YVELINESActions'
import { connect } from 'react-redux'

class GetYVELINESLITS extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/YVELINES/lits/${lit._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
