...
import { postLITS } from 'actions/maps/mapsYvelinesActions'

class PostYVELINESLITSMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostYVELINESLITSMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostYVELINESLITSMaps))
)
