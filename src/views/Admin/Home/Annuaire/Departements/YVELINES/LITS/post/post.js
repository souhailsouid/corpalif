...
import { postLITS } from 'actions/YVELINESActions'

class PostYVELINESLITS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostYVELINESLITS))
)
