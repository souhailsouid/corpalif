	...
	<div>
		<GridContainer>
			...
			>
				...
				<Grid item xs={4} style={{ textAlign: 'right' }}>
					<Link to={`/admin/YVELINES/autres_structures/${autres_structures._id}`}>{get}</Link>
					<Link to={`/admin/update/YVELINES/autres_structures/${autres_structures._id}`}>{update}</Link>
					<Link to={`/admin/delete/YVELINES/autres_structures/${autres_structures._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
