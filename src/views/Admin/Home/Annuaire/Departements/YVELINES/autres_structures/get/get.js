...
import { getCurrentStructure_id_autres_structures, deleteStructure_id_autres_structures } from 'actions/YVELINESActions'
import { connect } from 'react-redux'

class GetYVELINESautres_structures extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/YVELINES/autres_structures/${autres_structures._id}`}>
								{deleteButton}
							</Link>
						</Grid>
					</GridItem>
...
GetYVELINESautres_structures.propTypes = {
...
})(withRouter(GetYVELINESautres_structures))
