		...
		<GridContainer>
			...
			>
				...
				<Grid item xs={3} style={{ textAlign: 'right' }}>
					<Link to={`/admin/update/YVELINES/maps/autres_structures/${mapautresstructure._id}`}>{update}</Link>
					<Link to={`/admin/delete/YVELINES/maps/autres_structures/${mapautresstructure._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
