...
import { deleteStructure_id_autres_structures } from 'actions/YVELINESActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/YVELINES/autres_structures'))}
