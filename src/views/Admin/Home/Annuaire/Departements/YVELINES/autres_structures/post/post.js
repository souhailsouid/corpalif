...
import { post_autres_structures } from 'actions/YVELINESActions'

class PostYVELINESautres_structures extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostYVELINESautres_structures.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres_structures })(withRouter(PostYVELINESautres_structures))
)
