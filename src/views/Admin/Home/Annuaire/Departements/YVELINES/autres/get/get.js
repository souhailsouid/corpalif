...
import { getCurrentStructure_id_autres, deleteStructure_id_autres } from 'actions/YVELINESActions'
import { connect } from 'react-redux'

class GetYVELINESautres extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/YVELINES/autres/${autres._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
