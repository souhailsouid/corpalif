...
import { updateStructureAutres, getCurrentStructure_idAutres } from 'actions/maps/mapsYvelinesActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/YVELINES/autres')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/YVELINES/autres'))}
