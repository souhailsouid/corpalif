...
import { post_autres } from 'actions/YVELINESActions'

class PostYVELINESautres extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres })(withRouter(PostYVELINESautres))
)
