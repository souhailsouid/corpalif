...
import { postAutres } from 'actions/maps/mapsYvelinesActions'

class PostYVELINESAUTRESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostYVELINESAUTRESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAutres })(withRouter(PostYVELINESAUTRESMaps))
)
