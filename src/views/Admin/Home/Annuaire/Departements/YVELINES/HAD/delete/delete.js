...
import { deleteStructure_idHAD } from 'actions/YVELINESActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/YVELINES/had'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/YVELINES/had'))}
								color="secondary"
							>
								Annuler
							</Button>
