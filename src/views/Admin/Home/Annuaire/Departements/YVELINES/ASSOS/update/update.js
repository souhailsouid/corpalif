...
import { updateStructureAssos, getCurrentStructure_idAssos } from 'actions/YVELINESActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/admin/YVELINES/association')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/YVELINES/association'))}
