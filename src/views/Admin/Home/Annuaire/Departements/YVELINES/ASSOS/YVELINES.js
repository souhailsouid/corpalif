...
import { getCurrentStructureAssos, deleteStructure_id } from 'actions/YVELINESActions'
...
class YVELINESASSOS extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
					...
					<div className={classes.container}>
						...
						<GridItem xs={12} sm={10} md={12}>
							...
							>
								...
								<Link to="/admin/post/YVELINES/association">
...
<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/YVELINES/maps/association">
									<Button round variant="fab" color="green" aria-label="Add">
										<AddIcon />
									</Button>
								</Link>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureAssos, deleteStructure_id, getCurrentStructureAssociationMaps })(withRouter(YVELINESASSOS))
)
