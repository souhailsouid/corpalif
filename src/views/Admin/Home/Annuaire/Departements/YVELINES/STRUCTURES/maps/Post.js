...
import { postAssos } from 'actions/maps/mapsYvelinesActions'

class PostYVELINESSTRUCTURESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostYVELINESSTRUCTURESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postHAD })(withRouter(PostYVELINESSTRUCTURESMaps))
)
