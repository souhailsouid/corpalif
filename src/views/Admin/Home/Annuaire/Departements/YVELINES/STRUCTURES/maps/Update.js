...
import { updateStructureHAD, getCurrentStructure_idHAD } from 'actions/maps/mapsYvelinesActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/YVELINES/structures')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/YVELINES/structures'))}
