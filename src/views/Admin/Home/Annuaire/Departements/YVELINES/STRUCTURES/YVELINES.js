...
import { getCurrentStructureSOINS, deleteStructure_idSOINS } from 'actions/YVELINESActions'
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureSOINS, deleteStructure_idSOINS })(withRouter(YVELINESTRUCTURES))
)
