...
import { postReseaux } from 'actions/YVELINESActions'

class PostYVELINESRESEAUX extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostYVELINESRESEAUX))
)
