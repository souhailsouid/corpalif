...
import { deleteStructure_idReseaux } from 'actions/maps/mapsYvelinesActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/YVELINES/reseaux'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/YVELINES/reseaux'))}
								color="secondary"
							>
								Annuler
							</Button>
