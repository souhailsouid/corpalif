...
import { postReseaux } from 'actions/maps/paris/mapsYvelinesActions'

class PostYVELINESRESEAUXMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostYVELINESRESEAUXMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostYVELINESRESEAUXMaps))
)
