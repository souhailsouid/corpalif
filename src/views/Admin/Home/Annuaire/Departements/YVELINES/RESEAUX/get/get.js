...
import { getCurrentStructure_idReseaux, deleteStructure_idReseaux } from 'actions/YVELINESActions'
import { connect } from 'react-redux'

class GetYVELINESRESEAUX extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/YVELINES/usp/${reseaux._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
