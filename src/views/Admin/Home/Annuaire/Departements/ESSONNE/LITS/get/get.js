...
import { getCurrentStructure_idLITS, deleteStructure_idLITS } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'

class GetESSONNELITS extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/ESSONNE/lits/${lit._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
