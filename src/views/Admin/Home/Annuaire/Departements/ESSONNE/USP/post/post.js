...
import { post } from 'actions/ESSONNEActions'

class PostUSPESSONNE extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(connect(mapStateTopProps, { post })(withRouter(PostUSPESSONNE)))
