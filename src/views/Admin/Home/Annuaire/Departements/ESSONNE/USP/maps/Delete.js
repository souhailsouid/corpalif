...
import { deleteStructure_id } from 'actions/maps/mapsEssonneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/ESSONNE/usp'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/ESSONNE/usp'))}
								color="secondary"
							>
								Annuler
							</Button>
