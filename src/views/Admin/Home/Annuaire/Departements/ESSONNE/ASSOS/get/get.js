...
import { getCurrentStructure_idAssos, deleteStructure_idAssos } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'

class GetESSONNEASSOS extends Component {
	componentDidMount() {
