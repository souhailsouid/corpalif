...
import { getCurrentStructure_id_autres, deleteStructure_id_autres } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'

class GetESSONNEautres extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/ESSONNE/autres/${autres._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
