...
import { updateStructureAutres, getCurrentStructure_idAutres } from 'actions/maps/mapsEssonneActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/ESSONNE/autres')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/ESSONNE/autres'))}
