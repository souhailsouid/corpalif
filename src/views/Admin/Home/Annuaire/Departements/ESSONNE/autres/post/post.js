...
import { post_essonne_autres } from 'actions/ESSONNEActions'

class PostESSONNEautres extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	onSubmit(e) {
		...
		this.props.post_essonne_autres(Data, this.props.history)
	}
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_essonne_autres })(withRouter(PostESSONNEautres))
)
