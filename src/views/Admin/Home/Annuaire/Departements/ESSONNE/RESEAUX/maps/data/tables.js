		...
		<GridContainer>
			...
			>
				...
				<Grid item xs={3} style={{ textAlign: 'right' }}>
					<Link to={`/admin/update/ESSONNE/maps/association/${mapreseaux._id}`}>{update}</Link>
					<Link to={`/admin/delete/ESSONNE/maps/association/${mapreseaux._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
