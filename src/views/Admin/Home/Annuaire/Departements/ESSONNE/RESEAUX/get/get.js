...
import { getCurrentStructure_idReseaux, deleteStructure_idReseaux } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'

class GetESSONNERESEAUX extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/ESSONNE/usp/${reseaux._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
