...
import { postReseaux } from 'actions/ESSONNEActions'

class PostESSONNERESEAUX extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostESSONNERESEAUX))
)
