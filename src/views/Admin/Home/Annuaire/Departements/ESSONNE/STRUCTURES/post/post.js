...
import { postSOINS } from 'actions/ESSONNEActions'

class PostESSONNESTRUCTURES extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostESSONNESTRUCTURES.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postSOINS })(withRouter(PostESSONNESTRUCTURES))
)
