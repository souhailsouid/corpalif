...
import { getCurrentStructure_idSOINS, deleteStructure_idSOINS } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'

class GetESSONNESTRUCTURES extends Component {
	componentDidMount() {
...
GetESSONNESTRUCTURES.propTypes = {
...
export default connect(mapStateToProps, { getCurrentStructure_idSOINS, deleteStructure_idSOINS })(
	withRouter(GetESSONNESTRUCTURES)
)
