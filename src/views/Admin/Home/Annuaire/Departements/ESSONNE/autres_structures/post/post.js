...
import { post_essonne_autres_structures } from 'actions/ESSONNEActions'

class PostESSONNEautres_structures extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	onSubmit(e) {
		...
		this.props.post_essonne_autres_structures(Data, this.props.history)
	}
...
PostESSONNEautres_structures.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_essonne_autres_structures })(withRouter(PostESSONNEautres_structures))
)
