...
import { getCurrentStructure_id_autres_structures, deleteStructure_id_autres_structures } from 'actions/ESSONNEActions'
import { connect } from 'react-redux'

class GetESSONNEautres_structures extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/ESSONNE/autres_structures/${autres_structures._id}`}>
								{deleteButton}
							</Link>
						</Grid>
					</GridItem>
...
GetESSONNEautres_structures.propTypes = {
...
})(withRouter(GetESSONNEautres_structures))
