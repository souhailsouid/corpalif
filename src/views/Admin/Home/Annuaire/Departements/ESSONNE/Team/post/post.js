...
import { postTEAM } from 'actions/ESSONNEActions'

class PostESSONNEHAD extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostESSONNEHAD))
)
