	...
	<div>
		<GridContainer>
			...
			>
				...
				<Grid item xs={4} style={{ textAlign: 'right' }}>
					<Link to={`/admin/ESSONNE/equipesmobiles/${had._id}`}>{get}</Link>
					<Link to={`/admin/update/ESSONNE/equipesmobiles/${had._id}`}>{update}</Link>
					<Link to={`/admin/delete/ESSONNE/equipesmobiles/${had._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
