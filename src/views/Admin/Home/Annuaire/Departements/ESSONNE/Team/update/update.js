...
import { updateStructureTEAM, getCurrentStructure_idTEAM } from 'actions/ESSONNEActions'
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/ESSONNE/equipesmobiles'))}
