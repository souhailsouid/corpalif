...
import { deleteStructure_idHAD } from 'actions/annuaireActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/paris/had'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/paris/had'))}
								color="secondary"
							>
								Annuler
							</Button>
