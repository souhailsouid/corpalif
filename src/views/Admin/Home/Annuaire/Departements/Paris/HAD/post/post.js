...
import { postHAD } from 'actions/annuaireActions'
...
export default compose(withStyles(presentationStyle))(connect(mapStateTopProps, { postHAD })(withRouter(PostPARISHAD)))
