...
import { getCurrentStructure_idReseaux, deleteStructure_idReseaux } from 'actions/annuaireActions'
import { connect } from 'react-redux'

class GetPARISRESEAUX extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/paris/usp/${reseaux._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
