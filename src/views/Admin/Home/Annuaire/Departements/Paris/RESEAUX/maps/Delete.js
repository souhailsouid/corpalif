...
import { deleteStructure_idReseaux } from 'actions/maps/mapsParisActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/paris/reseaux'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/paris/reseaux'))}
								color="secondary"
							>
								Annuler
							</Button>
