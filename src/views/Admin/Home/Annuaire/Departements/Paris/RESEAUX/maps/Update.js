...
import { updateStructureReseaux, getCurrentStructure_idReseaux } from 'actions/maps/mapsParisActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/paris/reseaux')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/paris/reseaux'))}
