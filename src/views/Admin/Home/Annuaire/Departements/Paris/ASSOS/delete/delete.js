...
import { deleteStructure_idAssos } from 'actions/annuaireActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/paris/association'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/paris/association'))}
								color="secondary"
							>
								Annuler
							</Button>
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { deleteStructure_idAssos })(withRouter(Modal))
)
