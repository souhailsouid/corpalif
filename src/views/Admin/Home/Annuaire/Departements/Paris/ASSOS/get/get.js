...
import { getCurrentStructure_idAssos, deleteStructure_idAssos } from 'actions/annuaireActions'
import { connect } from 'react-redux'

class GetPARISASSOS extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/paris/association/${association._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
