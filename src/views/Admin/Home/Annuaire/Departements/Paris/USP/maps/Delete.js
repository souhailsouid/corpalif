...
import { deleteStructure_id } from 'actions/maps/mapsParisActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/paris/usp'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/paris/usp'))}
								color="secondary"
							>
								Annuler
							</Button>
