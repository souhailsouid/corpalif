...
import { post } from 'actions/maps/mapsParisActions'

class PostPARISUSPMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostPARISUSPMaps))
)
