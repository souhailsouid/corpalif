...
import { postLITS } from 'actions/annuaireActions'

class PostPARISLITS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostPARISLITS))
)
