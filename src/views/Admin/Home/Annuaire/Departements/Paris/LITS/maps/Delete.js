...
import { deleteStructure_idLITS } from 'actions/maps/mapsParisActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/paris/lits'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/paris/lits'))}
								color="secondary"
							>
								Annuler
							</Button>
