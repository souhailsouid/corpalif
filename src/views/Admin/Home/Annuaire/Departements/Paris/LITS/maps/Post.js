...
import { postLITS } from 'actions/maps/mapsParisActions'

class PostPARISLITSMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostPARISLITSMaps))
)
