...
import { updateStructureLITS, getCurrentStructure_idLITS } from 'actions/maps/mapsParisActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/paris/lits')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/paris/lits'))}
