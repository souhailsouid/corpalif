...
import { updateStructureAutres, getCurrentStructure_idAutres } from 'actions/maps/mapsParisActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/paris/autres')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/paris/autres'))}
