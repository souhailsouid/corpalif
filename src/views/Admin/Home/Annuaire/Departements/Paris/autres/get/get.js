...
import { getCurrentStructure_id_autres, deleteStructure_id_autres } from 'actions/annuaireActions'
import { connect } from 'react-redux'

class GetParisautres extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/Paris/autres/${autres._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
