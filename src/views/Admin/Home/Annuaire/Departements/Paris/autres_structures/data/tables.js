	...
	<div>
		<GridContainer>
			...
			>
				...
				<Grid item xs={4} style={{ textAlign: 'right' }}>
					<Link to={`/admin/paris/autres_structures/${autres_structures._id}`}>{get}</Link>
					<Link to={`/admin/update/paris/autres_structures/${autres_structures._id}`}>{update}</Link>
					<Link to={`/admin/delete/paris/autres_structures/${autres_structures._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
