...
import { deleteStructure_id_autres_structures } from 'actions/annuaireActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/Paris/autres_structures'))}
