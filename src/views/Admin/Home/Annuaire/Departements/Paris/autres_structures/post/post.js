...
import { post_autres_structures } from 'actions/annuaireActions'

class PostParisautres_structures extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostParisautres_structures.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres_structures })(withRouter(PostParisautres_structures))
)
