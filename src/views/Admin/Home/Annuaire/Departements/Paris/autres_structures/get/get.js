...
import { getCurrentStructure_id_autres_structures, deleteStructure_id_autres_structures } from 'actions/annuaireActions'
import { connect } from 'react-redux'

class GetParisautres_structures extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/Paris/autres_structures/${autres_structures._id}`}>
								{deleteButton}
							</Link>
						</Grid>
					</GridItem>
...
GetParisautres_structures.propTypes = {
...
})(withRouter(GetParisautres_structures))
