...
import { getCurrentStructure_idSOINS, deleteStructure_idSOINS } from 'actions/annuaireActions'
import { connect } from 'react-redux'

class GetPARISSTRUCTURES extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/paris/usp/${soin._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
