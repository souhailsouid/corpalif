...
import { deleteStructure_idHAD } from 'actions/maps/mapsParisActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/paris/structures'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/paris/structures'))}
								color="secondary"
							>
								Annuler
							</Button>
