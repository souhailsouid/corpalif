...
import { postSOINS } from 'actions/annuaireActions'

class PostPARISSTRUCTURES extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postSOINS })(withRouter(PostPARISSTRUCTURES))
)
