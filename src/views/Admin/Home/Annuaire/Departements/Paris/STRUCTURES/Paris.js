...
import { getCurrentStructureSOINS, deleteStructure_idSOINS } from 'actions/annuaireActions'
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureSOINS, deleteStructure_idSOINS })(withRouter(ParisSTRUCTURES))
)
