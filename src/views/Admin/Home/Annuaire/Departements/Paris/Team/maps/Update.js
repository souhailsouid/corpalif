...
import { updateStructureAssosMaps, getCurrentStructure_idAssosMaps } from 'actions/maps/mapsParisActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/paris/equipesmobiles')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/paris/equipesmobiles'))}
