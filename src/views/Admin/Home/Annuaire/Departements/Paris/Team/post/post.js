...
import { postTEAM } from 'actions/annuaireActions'

class PostPARISHAD extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.auth.had) {
			const had = nextProps.auth.had
	...
	onSubmit(e) {
		...
		this.props.postTEAM(Data, this.props.history)
	}
...
export default compose(withStyles(presentationStyle))(connect(mapStateTopProps, { postTEAM })(withRouter(PostPARISHAD)))
