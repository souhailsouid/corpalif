...
import { getCurrentStructure_idTEAM, deleteStructure_idTEAM } from 'actions/annuaireActions'
...
export default connect(mapStateToProps, { getCurrentStructure_idTEAM, deleteStructure_idTEAM })(withRouter(GetPARISHAD))
