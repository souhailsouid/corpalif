...
import { postTEAM } from 'actions/maps/mapsParisActions'

class PostPARISTEAMMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostPARISTEAMMaps))
)
