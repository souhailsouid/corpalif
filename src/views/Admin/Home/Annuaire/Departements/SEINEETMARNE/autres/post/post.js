...
import { post_autres } from 'actions/SEINEETMARNEActions'

class PostSEINEETMARNEautres extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNEautres.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres })(withRouter(PostSEINEETMARNEautres))
)
