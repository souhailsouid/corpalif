...
import { postAutres } from 'actions/maps/mapsSeineetMarneActions'

class PostSEINEETMARNEAUTRESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNEAUTRESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAutres })(withRouter(PostSEINEETMARNEAUTRESMaps))
)
