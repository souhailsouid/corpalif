...
import { postReseaux } from 'actions/maps/paris/mapsSeineetMarneActions'

class PostSEINEETMARNERESEAUXMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNERESEAUXMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostSEINEETMARNERESEAUXMaps))
)
