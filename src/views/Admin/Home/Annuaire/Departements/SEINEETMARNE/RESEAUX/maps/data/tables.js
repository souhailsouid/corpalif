		...
		<GridContainer>
			...
			>
				...
				<Grid item xs={3} style={{ textAlign: 'right' }}>
					<Link to={`/admin/update/SEINEETMARNE/maps/reseaux/${mapreseaux._id}`}>{update}</Link>
					<Link to={`/admin/delete/SEINEETMARNE/maps/reseaux/${mapreseaux._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
