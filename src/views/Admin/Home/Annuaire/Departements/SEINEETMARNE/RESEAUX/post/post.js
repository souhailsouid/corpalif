...
import { postReseaux } from 'actions/SEINEETMARNEActions'

class PostSEINEETMARNERESEAUX extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNERESEAUX.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostSEINEETMARNERESEAUX))
)
