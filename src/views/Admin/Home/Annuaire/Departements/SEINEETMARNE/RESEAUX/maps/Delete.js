...
import { deleteStructure_idReseaux } from 'actions/maps/mapsSeineetMarneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINEETMARNE/reseaux'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINEETMARNE/reseaux'))}
								color="secondary"
							>
								Annuler
							</Button>
