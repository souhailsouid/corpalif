...
import { postTEAM } from 'actions/SEINEETMARNEActions'

class PostSEINEETMARNEHAD extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostSEINEETMARNEHAD))
)
