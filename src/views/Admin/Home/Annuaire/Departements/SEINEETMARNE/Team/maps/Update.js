...
import { updateStructureAssosMaps, getCurrentStructure_idAssosMaps } from 'actions/maps/mapsSeineetMarneActions'
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/SEINEETMARNE/equipesmobiles'))}
