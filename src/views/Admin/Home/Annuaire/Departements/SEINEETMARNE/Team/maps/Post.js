...
import { postTEAM } from 'actions/maps/mapsSeineetMarneActions'

class PostSEINEETMARNETEAMMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		if (nextProps.auth.mapteam) {
			const mapteam = nextProps.auth.mapteam
...
PostSEINEETMARNETEAMMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostSEINEETMARNETEAMMaps))
)
