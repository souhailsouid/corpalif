...
import { deleteStructure_idHAD } from 'actions/SEINEETMARNEActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINEETMARNE/had'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINEETMARNE/had'))}
								color="secondary"
							>
								Annuler
							</Button>
