...
import { deleteStructure_idHAD } from 'actions/maps/mapsSeineetMarneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINEETMARNE/structures'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINEETMARNE/structures'))}
								color="secondary"
							>
								Annuler
							</Button>
