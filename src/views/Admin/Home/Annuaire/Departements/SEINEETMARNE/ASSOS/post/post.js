...
import { postAssos } from 'actions/SEINEETMARNEActions'

class PostSEINEETMARNEASSOS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNEASSOS.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAssos })(withRouter(PostSEINEETMARNEASSOS))
)
