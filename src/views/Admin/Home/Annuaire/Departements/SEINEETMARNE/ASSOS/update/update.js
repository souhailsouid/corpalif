...
import { updateStructureAssos, getCurrentStructure_idAssos } from 'actions/SEINEETMARNEActions'
...
class Modal extends React.Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.association.association) {
			const association = nextProps.association.association

			// If association field doesnt exist, make empty string
			association.name = !isEmpty(association.name) ? association.name : ''
			association.email = !isEmpty(association.email) ? association.email : ''
			association.phone = !isEmpty(association.phone) ? association.phone : ''
			association.rue = !isEmpty(association.rue) ? association.rue : ''
			association.compl = !isEmpty(association.compl) ? association.compl : ''
			association.postcode = !isEmpty(association.postcode) ? association.postcode : ''
			association.web = !isEmpty(association.web) ? association.web : ''
	...
	onSubmit(e) {
		...
		window.location.replace('/#/admin/SEINEETMARNE/association')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/#/admin/SEINEETMARNE/association'))}
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { updateStructureAssos, getCurrentStructure_idAssos })(withRouter(Modal))
)
