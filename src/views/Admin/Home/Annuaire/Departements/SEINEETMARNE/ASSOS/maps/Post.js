...
import { postAssos } from 'actions/maps/mapsSeineetMarneActions'

class PostSEINEETMARNEASSOSMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNEASSOSMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAssos })(withRouter(PostSEINEETMARNEASSOSMaps))
)
