...
import { postLITS } from 'actions/maps/mapsSeineetMarneActions'

class PostSEINEETMARNELITSMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		if (nextProps.auth.maplit) {
			const maplit = nextProps.auth.maplit
	...
	onSubmit(e) {
		...
		this.props.postLITS(Data, this.props.history)
	}
...
PostSEINEETMARNELITSMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostSEINEETMARNELITSMaps))
)
