...
import { deleteStructure_idLITS } from 'actions/maps/mapsSeineetMarneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINEETMARNE/lits'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINEETMARNE/lits'))}
								color="secondary"
							>
								Annuler
							</Button>
