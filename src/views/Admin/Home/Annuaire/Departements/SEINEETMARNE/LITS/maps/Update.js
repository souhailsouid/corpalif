...
import { updateStructureLITS, getCurrentStructure_idLITS } from 'actions/maps/mapsSeineetMarneActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/SEINEETMARNE/lits')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/SEINEETMARNE/lits'))}
