...
import { postLITS } from 'actions/SEINEETMARNEActions'

class PostSEINEETMARNELITS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNELITS.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostSEINEETMARNELITS))
)
