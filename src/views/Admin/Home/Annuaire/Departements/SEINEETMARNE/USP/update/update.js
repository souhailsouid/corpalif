...
import { updateStructure, getCurrentStructure_id } from 'actions/SEINEETMARNEActions'
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/SEINEETMARNE/usp'))}
