...
import { post } from 'actions/maps/mapsSeineetMarneActions'

class PostSEINEETMARNEUSPMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNEUSPMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostSEINEETMARNEUSPMaps))
)
