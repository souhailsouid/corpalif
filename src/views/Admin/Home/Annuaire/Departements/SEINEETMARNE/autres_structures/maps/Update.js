...
} from 'actions/maps/mapsSeineetMarneActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/SEINEETMARNE/autres_structures')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/SEINEETMARNE/autres_structures'))}
