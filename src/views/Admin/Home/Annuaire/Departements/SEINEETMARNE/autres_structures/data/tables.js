	...
	<div>
		<GridContainer>
			...
			>
				...
				<Grid item xs={4} style={{ textAlign: 'right' }}>
					<Link to={`/admin/seineetmarne/autres_structures/${autres_structures._id}`}>{get}</Link>
					<Link to={`/admin/update/seineetmarne/autres_structures/${autres_structures._id}`}>{update}</Link>
