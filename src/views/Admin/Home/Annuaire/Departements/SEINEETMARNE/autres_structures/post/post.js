...
import { post_autres_structures } from 'actions/SEINEETMARNEActions'

class PostSEINEETMARNEautres_structures extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINEETMARNEautres_structures.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres_structures })(withRouter(PostSEINEETMARNEautres_structures))
)
