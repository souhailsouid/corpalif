...
import { deleteStructure_id_autres_structures } from 'actions/SEINEETMARNEActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() =>
							this.handleClose(window.location.replace('/admin/SEINEETMARNE/autres_structures'))}
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { deleteStructure_id_autres_structures })(withRouter(Modal))
)
