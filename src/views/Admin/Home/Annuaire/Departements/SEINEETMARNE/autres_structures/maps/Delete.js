...
import { deleteStructure_idAssosMaps } from 'actions/maps/mapsSeineetMarneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINEETMARNE/autres_structures'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINEETMARNE/autres_structures'))}
								color="secondary"
							>
								Annuler
							</Button>
