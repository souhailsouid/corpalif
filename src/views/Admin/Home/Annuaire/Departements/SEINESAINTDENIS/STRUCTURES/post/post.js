...
class PostSEINESAINTDENISSTRUCTURES extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINESAINTDENISSTRUCTURES.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postSOINS })(withRouter(PostSEINESAINTDENISSTRUCTURES))
)
