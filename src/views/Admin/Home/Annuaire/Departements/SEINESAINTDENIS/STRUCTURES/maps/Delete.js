...
import { deleteStructure_idHAD } from 'actions/maps/mapsSeineSaintDenisActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINESAINTDENIS/structures'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINESAINTDENIS/structures'))}
								color="secondary"
							>
								Annuler
							</Button>
