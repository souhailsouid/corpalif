...
import { updateStructureHAD, getCurrentStructure_idHAD } from 'actions/SEINESAINTDENISActions'
...
class Modal extends React.Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.soin.soin) {
			const soin = nextProps.soin.soin

			// If soin field doesnt exist, make empty string
			soin.name = !isEmpty(soin.name) ? soin.name : ''
			soin.email = !isEmpty(soin.email) ? soin.email : ''
			soin.phone = !isEmpty(soin.phone) ? soin.phone : ''
			soin.rue = !isEmpty(soin.rue) ? soin.rue : ''
			soin.compl = !isEmpty(soin.compl) ? soin.compl : ''
			soin.postcode = !isEmpty(soin.postcode) ? soin.postcode : ''
			soin.web = !isEmpty(soin.web) ? soin.web : ''
	...
	onSubmit(e) {
		...
		window.location.replace('/#/admin/SEINESAINTDENIS/structures')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/#/admin/SEINESAINTDENIS/structures'))}
