...
import { updateStructureHAD, getCurrentStructure_idHAD } from 'actions/maps/mapsSeineSaintDenisActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/SEINESAINTDENIS/structures')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/SEINESAINTDENIS/structures'))}
