...
import { getCurrentStructureSOINS, deleteStructure_idSOINS } from 'actions/SEINESAINTDENISActions'
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureSOINS, deleteStructure_idSOINS })(
		withRouter(SEINESAINTDENISTRUCTURES)
	)
)
