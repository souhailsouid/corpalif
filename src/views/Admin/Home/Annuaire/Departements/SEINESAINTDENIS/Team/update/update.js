...
import { updateStructureTEAM, getCurrentStructure_idTEAM } from 'actions/SEINESAINTDENISActions'
...
class Modal extends React.Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.had.had) {
			const had = nextProps.had.had

			// If had field doesnt exist, make empty string
			had.name = !isEmpty(had.name) ? had.name : ''
			had.email = !isEmpty(had.email) ? had.email : ''
			had.phone = !isEmpty(had.phone) ? had.phone : ''
			had.rue = !isEmpty(had.rue) ? had.rue : ''
			had.compl = !isEmpty(had.compl) ? had.compl : ''
			had.postcode = !isEmpty(had.postcode) ? had.postcode : ''
			had.web = !isEmpty(had.web) ? had.web : ''
	...
	onSubmit(e) {
		...
		this.props.updateStructureTEAM(this.props.match.params.id, Data)
		window.location.replace('/admin/SEINESAINTDENIS/had')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/SEINESAINTDENIS/had'))}
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { updateStructureTEAM, getCurrentStructure_idTEAM })(withRouter(Modal))
)
