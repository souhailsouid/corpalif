...
import { getCurrentStructureTEAM, deleteStructure_idTEAM } from 'actions/SEINESAINTDENISActions'
import { connect } from 'react-redux'
import { compose } from 'redux'
import { Map as LeafletMap, Marker, Popup, TileLayer } from 'react-leaflet'
import { getCurrentStructureTEAMMAPS } from 'actions/maps/mapsSeineSaintDenisActions'
...
class SEINESAINTDENISHAD extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
					...
					<div className={classes.container}>
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les equipes mobiles à SEINE SAINT DENIS{' '}
										</h3>
									</div>
								</div>
							</GridItem>
						...
						<GridItem xs={12} sm={10} md={12}>
							...
							>
								...
								<Link to="/admin/post/SEINESAINTDENIS/equipesmobiles">
						...
						<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/SEINESAINTDENIS/maps/equipesmobiles">
									<Button round variant="fab" color="green" aria-label="Add">
										<AddIcon />
									</Button>
								</Link>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureTEAM, deleteStructure_idTEAM, getCurrentStructureTEAMMAPS })(withRouter(SEINESAINTDENISHAD))
)
