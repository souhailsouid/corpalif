...
import { postTEAM } from 'actions/SEINESAINTDENISActions'

class PostSEINESAINTDENISHAD extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINESAINTDENISHAD.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostSEINESAINTDENISHAD))
)
