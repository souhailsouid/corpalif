...
class GetSEINESAINTDENISautres_structures extends Component {
	componentDidMount() {
...
GetSEINESAINTDENISautres_structures.propTypes = {
...
export default connect(mapStateToProps, {
	getCurrentStructure_id_autres_structures,
	deleteStructure_id_autres_structures
})(withRouter(GetSEINESAINTDENISautres_structures))
