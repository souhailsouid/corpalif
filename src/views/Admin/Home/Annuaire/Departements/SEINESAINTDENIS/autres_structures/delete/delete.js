...
import { deleteStructure_id_autres_structures } from 'actions/SEINESAINTDENISActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() =>
							this.handleClose(window.location.replace('/#/admin/SEINESAINTDENIS/autres_structures'))}
