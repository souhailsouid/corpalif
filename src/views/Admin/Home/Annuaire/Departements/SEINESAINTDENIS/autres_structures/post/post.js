...
import { post_autres_structures } from 'actions/SEINESAINTDENISActions'

class PostSEINESAINTDENISautres_structures extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.auth.autres_structures) {
			const autres_structures = nextProps.auth.autres_structures
	...
	onSubmit(e) {
		...
		this.props.post_autres_structures(Data, this.props.history)
	}
...
PostSEINESAINTDENISautres_structures.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres_structures })(withRouter(PostSEINESAINTDENISautres_structures))
)
