...
import { deleteStructure_idAssosMaps } from 'actions/maps/mapsSeineSaintDenisActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINESAINTDENIS/autres_structures'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINESAINTDENIS/autres_structures'))}
								color="secondary"
							>
								Annuler
							</Button>
...
const mapStateTopProps = (state) => ({
	mapautresstructure: state.mapassociation,
	auth: state.auth
})
