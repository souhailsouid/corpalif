...
import { updateStructureReseaux, getCurrentStructure_idReseaux } from 'actions/SEINESAINTDENISActions'
...
class Modal extends React.Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.reseaux.reseaux) {
			...
			reseaux.rue = !isEmpty(reseaux.rue) ? reseaux.rue : ''
			reseaux.compl = !isEmpty(reseaux.compl) ? reseaux.compl : ''
			reseaux.postcode = !isEmpty(reseaux.postcode) ? reseaux.postcode : ''
			reseaux.web = !isEmpty(reseaux.web) ? reseaux.web : ''
