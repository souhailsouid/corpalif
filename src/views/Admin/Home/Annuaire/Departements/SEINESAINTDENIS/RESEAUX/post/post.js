...
import { postReseaux } from 'actions/SEINESAINTDENISActions'

class PostSEINESAINTDENISRESEAUX extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.auth.reseaux) {
			const reseaux = nextProps.auth.reseaux
...
PostSEINESAINTDENISRESEAUX.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostSEINESAINTDENISRESEAUX))
)
