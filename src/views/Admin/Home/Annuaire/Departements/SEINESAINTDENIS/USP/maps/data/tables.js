		...
		<GridContainer>
			...
			>
				...
				<Grid item xs={3} style={{ textAlign: 'right' }}>
					<Link to={`/admin/update/SEINESAINTDENIS/maps/usp/${mapusp._id}`}>{update}</Link>
					<Link to={`/admin/delete/SEINESAINTDENIS/maps/usp/${mapusp._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
