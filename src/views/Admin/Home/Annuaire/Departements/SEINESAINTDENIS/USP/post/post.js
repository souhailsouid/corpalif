...
import { post } from 'actions/VALDEMARNEActions'

class PostUSPVALDEMARNE extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostUSPVALDEMARNE))
)
