...
import { deleteStructure_id } from 'actions/maps/mapsSeineSaintDenisActions'
...
class Modal extends React.Component {
	...
	onDeleteClick() {
		...
		window.location.replace('/admin/SEINESAINTDENIS/usp')
	}
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINESAINTDENIS/usp'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINESAINTDENIS/usp'))}
								color="secondary"
							>
								Annuler
							</Button>
