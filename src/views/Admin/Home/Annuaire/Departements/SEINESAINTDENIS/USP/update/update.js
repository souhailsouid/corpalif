...
import { updateStructure, getCurrentStructure_id } from 'actions/VALDEMARNEActions'
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/VALDEMARNE/usp'))}
