...
import { post } from 'actions/maps/mapsSeineSaintDenisActions'

class PostSEINESAINTDENISUSPMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		if (nextProps.auth.mapusp) {
			const mapusp = nextProps.auth.mapusp
...
PostSEINESAINTDENISUSPMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostSEINESAINTDENISUSPMaps))
)
