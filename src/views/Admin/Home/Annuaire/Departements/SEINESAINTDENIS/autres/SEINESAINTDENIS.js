...
import { getCurrentStructure_autres, deleteStructure_id_autres } from 'actions/SEINESAINTDENISActions'
import { connect } from 'react-redux'
import { compose } from 'redux'

class SEINESAINTDENISautres extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
					...
					<div className={classes.container}>
						...
						<GridItem xs={12} sm={10} md={12}>
							<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/SEINESAINTDENIS/autres">
...
SEINESAINTDENISautres.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructure_autres, deleteStructure_id_autres })(
		withRouter(SEINESAINTDENISautres)
	)
)
