...
import { postAutres } from 'actions/maps/mapsSeineSaintDenisActions'

class PostSEINESAINTDENISAUTRESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		if (nextProps.auth.mapautre) {
			const mapautre = nextProps.auth.mapautre
	...
	onSubmit(e) {
		...
		this.props.postAutres(Data, this.props.history)
	}
...
PostSEINESAINTDENISAUTRESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAutres })(withRouter(PostSEINESAINTDENISAUTRESMaps))
)
