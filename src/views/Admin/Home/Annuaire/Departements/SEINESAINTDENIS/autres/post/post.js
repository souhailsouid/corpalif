...
import { post_autres } from 'actions/SEINESAINTDENISActions'

class PostSEINESAINTDENISautres extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.auth.autres) {
			const autres = nextProps.auth.autres
	...
	onSubmit(e) {
		...
		this.props.post_autres(Data, this.props.history)
	}
...
PostSEINESAINTDENISautres.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres })(withRouter(PostSEINESAINTDENISautres))
)
