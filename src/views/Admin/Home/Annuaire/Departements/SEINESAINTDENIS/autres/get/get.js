...
import { getCurrentStructure_id_autres, deleteStructure_id_autres } from 'actions/SEINESAINTDENISActions'
import { connect } from 'react-redux'

class GetSEINESAINTDENISautres extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/SEINESAINTDENIS/autres/${autres._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
...
GetSEINESAINTDENISautres.propTypes = {
...
})(withRouter(GetSEINESAINTDENISautres))
