...
import { deleteStructure_idHAD } from 'actions/SEINESAINTDENISActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/SEINESAINTDENIS/had'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINESAINTDENIS/had'))}
								color="secondary"
							>
								Annuler
							</Button>
