...
import { deleteStructure_idLITS } from 'actions/maps/mapsSeineSaintDenisActions'
				...
				<div>
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/SEINESAINTDENIS/lits'))}
								color="secondary"
							>
								Annuler
							</Button>
