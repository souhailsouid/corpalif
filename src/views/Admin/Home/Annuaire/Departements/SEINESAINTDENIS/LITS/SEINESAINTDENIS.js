...
import { getCurrentStructureLITS, deleteStructure_idLITS } from 'actions/SEINESAINTDENISActions'
import { connect } from 'react-redux'
import { compose } from 'redux'
import { Map as LeafletMap, Marker, Popup, TileLayer } from 'react-leaflet'
import { getCurrentStructureLITSMAPS } from 'actions/maps/mapsSeineSaintDenisActions'
...
class SEINESAINTDENISLITS extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
					...
					<div className={classes.container}>
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les Lits identifiés en SEINE SAINT DENIS{' '}
										</h3>
									</div>
								</div>
							</GridItem>
						...
						<GridItem xs={12} sm={10} md={12}>
							...
							>
								...
								<Link to="/admin/post/SEINESAINTDENIS/lits">
	...
	<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/SEINESAINTDENIS/maps/LITS">
									<Button round variant="fab" color="green" aria-label="Add">
										<AddIcon />
									</Button>
								</Link>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureLITS, deleteStructure_idLITS, getCurrentStructureLITSMAPS })(withRouter(SEINESAINTDENISLITS))
)
