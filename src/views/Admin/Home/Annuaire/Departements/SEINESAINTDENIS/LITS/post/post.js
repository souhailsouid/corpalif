...
import { postLITS } from 'actions/SEINESAINTDENISActions'

class PostSEINESAINTDENISLITS extends Component {
	constructor(props) {
		super(props)
		this.state = {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.auth.lit) {
			const lit = nextProps.auth.lit
...
PostSEINESAINTDENISLITS.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostSEINESAINTDENISLITS))
)
