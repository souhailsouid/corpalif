...
import { getCurrentStructure_idAssos, deleteStructure_idAssos } from 'actions/SEINESAINTDENISActions'
import { connect } from 'react-redux'

class GetSEINESAINTDENISASSOS extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/SEINESAINTDENIS/association/${association._id}`}>
								{deleteButton}
							</Link>
						</Grid>
					</GridItem>
...
GetSEINESAINTDENISASSOS.propTypes = {
...
export default connect(mapStateToProps, { getCurrentStructure_idAssos, deleteStructure_idAssos })(
	withRouter(GetSEINESAINTDENISASSOS)
)
