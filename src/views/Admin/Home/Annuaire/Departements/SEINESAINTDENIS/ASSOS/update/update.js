...
import { updateStructureAssos, getCurrentStructure_idAssos } from 'actions/SEINESAINTDENISActions'
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/SEINESAINTDENIS/association'))}
