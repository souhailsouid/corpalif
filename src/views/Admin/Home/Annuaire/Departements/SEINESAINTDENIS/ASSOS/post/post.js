...
import { postAssos } from 'actions/SEINESAINTDENISActions'

class PostSEINESAINTDENISASSOS extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostSEINESAINTDENISASSOS.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAssos })(withRouter(PostSEINESAINTDENISASSOS))
)
