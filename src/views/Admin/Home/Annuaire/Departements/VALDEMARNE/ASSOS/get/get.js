...
import { getCurrentStructure_idAssos, deleteStructure_idAssos } from 'actions/VALDEMARNEActions'
import { connect } from 'react-redux'

class GetVALDEMARNEASSOS extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/VALDEMARNE/association/${association._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
