...
import { deleteStructure_id } from 'actions/maps/mapsValdeMarneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/#/admin/VALDEMARNE/usp'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/#/admin/VALDEMARNE/usp'))}
								color="secondary"
							>
								Annuler
							</Button>
