...
import { post } from 'actions/maps/mapsValdeMarneActions'

class PostVALDEMARNEUSPMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNEUSPMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post })(withRouter(PostVALDEMARNEUSPMaps))
)
