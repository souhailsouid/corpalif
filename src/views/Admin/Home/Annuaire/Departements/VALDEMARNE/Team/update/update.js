...
import { updateStructureTEAM, getCurrentStructure_idTEAM } from 'actions/VALDEMARNEActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/#/admin/VALDEMARNE/had')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/#/admin/VALDEMARNE/had'))}
