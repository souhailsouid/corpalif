...
import { postTEAM } from 'actions/maps/mapsValdeMarneActions'

class PostVALDEMARNETEAMMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNETEAMMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostVALDEMARNETEAMMaps))
)
