		...
		<GridContainer>
			...
			>
				...
				<Grid item xs={3} style={{ textAlign: 'right' }}>
					<Link to={`/admin/update/VALDEMARNE/maps/equipesmobiles/${mapteam._id}`}>{update}</Link>
					<Link to={`/admin/delete/VALDEMARNE/maps/equipesmobiles/${mapteam._id}`}>{deleteButton}</Link>
				</Grid>
			</GridItem>
		</GridContainer>
	</div>
