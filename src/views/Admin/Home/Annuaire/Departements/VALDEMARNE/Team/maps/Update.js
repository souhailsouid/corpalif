...
import { updateStructureAssosMaps, getCurrentStructure_idAssosMaps } from 'actions/maps/mapsValdeMarneActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/VALDEMARNE/equipesmobiles')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/VALDEMARNE/equipesmobiles'))}
