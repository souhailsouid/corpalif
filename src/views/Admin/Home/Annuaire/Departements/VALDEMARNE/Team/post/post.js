...
import { postTEAM } from 'actions/VALDEMARNEActions'

class PostVALDEMARNEHAD extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postTEAM })(withRouter(PostVALDEMARNEHAD))
)
