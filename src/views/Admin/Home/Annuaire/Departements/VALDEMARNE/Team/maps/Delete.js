...
import { deleteStructure_idAssosMaps } from 'actions/maps/mapsValdeMarneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/VALDEMARNE/equipesmobiles'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/VALDEMARNE/equipesmobiles'))}
								color="secondary"
							>
								Annuler
							</Button>
