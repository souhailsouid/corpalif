...
import { getCurrentStructure_idTEAM, deleteStructure_idTEAM } from 'actions/VALDEMARNEActions'
import { connect } from 'react-redux'

class GetVALDEMARNEHAD extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/VALDEMARNE/equipesmobiles/${had._id}`}>{deleteButton}</Link>
						</Grid>
					</GridItem>
				</GridContainer>
			</div>
