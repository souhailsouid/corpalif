...
import { getCurrentStructure_idLITS, deleteStructure_idLITS } from 'actions/VALDEMARNEActions'
import { connect } from 'react-redux'

class GetVALDEMARNELITS extends Component {
	componentDidMount() {
