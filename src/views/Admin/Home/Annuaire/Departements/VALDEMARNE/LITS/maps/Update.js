...
import { updateStructureLITS, getCurrentStructure_idLITS } from 'actions/maps/mapsValdeMarneActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/VALDEMARNE/lits')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/VALDEMARNE/lits'))}
