...
import { postLITS } from 'actions/maps/mapsValdeMarneActions'

class PostVALDEMARNELITSMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNELITSMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postLITS })(withRouter(PostVALDEMARNELITSMaps))
)
