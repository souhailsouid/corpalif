...
import { deleteStructure_idLITS } from 'actions/maps/mapsValdeMarneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/VALDEMARNE/lits'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/VALDEMARNE/lits'))}
								color="secondary"
							>
								Annuler
							</Button>
