...
import { deleteStructure_idHAD } from 'actions/maps/mapsValdeMarneActions'
			...
			<div>
				<div>
					...
					<Dialog
						...
						keepMounted
						onClose={() => this.handleClose(window.location.replace('/admin/VALDEMARNE/structures'))}
					...
					>
						...
						<DialogActions className={classes.modalFooter}>
							<Button
								onClick={() =>
									this.handleClose('liveDemo', window.location.replace('/admin/VALDEMARNE/structures'))}
								color="secondary"
							>
								Annuler
							</Button>
