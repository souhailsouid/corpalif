...
import { postAssos } from 'actions/maps/mapsValdeMarneActions'

class PostVALDEMARNESTRUCTURESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNESTRUCTURESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postHAD })(withRouter(PostVALDEMARNESTRUCTURESMaps))
)
