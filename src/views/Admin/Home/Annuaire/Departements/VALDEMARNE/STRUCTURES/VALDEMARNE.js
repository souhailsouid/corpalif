...
import { getCurrentStructureSOINS, deleteStructure_idSOINS } from 'actions/VALDEMARNEActions'
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureSOINS, deleteStructure_idSOINS })(withRouter(VALDEMARNETRUCTURES))
)
