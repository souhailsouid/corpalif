...
import { getCurrentStructureHAD, deleteStructure_idHAD } from 'actions/VALDEMARNEActions'
import { connect } from 'react-redux'
import { compose } from 'redux'
import { Map as LeafletMap, Marker, Popup, TileLayer } from 'react-leaflet'
import { getCurrentStructureHADMAPS } from 'actions/maps/mapsValdeMarneActions'
...
class VALDEMARNETRUCTURES extends React.Component {
	componentDidMount() {
		window.scrollTo(0, 0)
					...
					<div className={classes.container}>
								...
								<div className={classes.profile}>
									<div className={classes.name}>
										<h3 className={classes.title} style={{ color: '#cc4949' }}>
											{' '}
											Les STRUCTURES D'HOSPITALISATION À DOMICILE EN VAL DE MARNE{' '}
										</h3>
									</div>
								</div>
							</GridItem>
						...
						<GridItem xs={12} sm={10} md={12}>
							...
							>
								...
								<Link to="/admin/post/VALDEMARNE/structures">
						...
						<Grid xs={12} sm={10} md={12} style={{ textAlign: 'right', justifyContent: 'right' }}>
								...
								<Link to="/admin/post/VALDEMARNE/maps/structures">
									<Button round variant="fab" color="green" aria-label="Add">
										<AddIcon />
									</Button>
								</Link>
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getCurrentStructureHAD, deleteStructure_idHAD, getCurrentStructureHADMAPS })(withRouter(VALDEMARNETRUCTURES))
)
