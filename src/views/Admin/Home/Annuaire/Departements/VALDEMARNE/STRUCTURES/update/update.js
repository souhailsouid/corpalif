...
import { updateStructureHAD, getCurrentStructure_idHAD } from 'actions/VALDEMARNEActions'
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() =>
						this.handleClose('searchModal', window.location.replace('/admin/VALDEMARNE/structures'))}
