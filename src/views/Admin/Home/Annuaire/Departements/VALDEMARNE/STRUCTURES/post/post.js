...
class PostVALDEMARNESTRUCTURES extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNESTRUCTURES.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postSOINS })(withRouter(PostVALDEMARNESTRUCTURES))
)
