...
import { post_autres_structures } from 'actions/VALDEMARNEActions'

class PostVALDEMARNEautres_structures extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNEautres_structures.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres_structures })(withRouter(PostVALDEMARNEautres_structures))
)
