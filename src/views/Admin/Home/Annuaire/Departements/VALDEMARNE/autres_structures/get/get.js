...
class GetVALDEMARNEautres_structures extends Component {
	componentDidMount() {
			...
			<div>
				<GridContainer>
					...
					>
						...
						<Grid item xs={4} style={{ textAlign: 'right' }}>
							<Link to={`/admin/delete/VALDEMARNE/autres_structures/${autres_structures._id}`}>
								{deleteButton}
							</Link>
						</Grid>
					</GridItem>
...
GetVALDEMARNEautres_structures.propTypes = {
...
export default connect(mapStateToProps, {
	getCurrentStructure_id_autres_structures,
	deleteStructure_id_autres_structures
})(withRouter(GetVALDEMARNEautres_structures))
