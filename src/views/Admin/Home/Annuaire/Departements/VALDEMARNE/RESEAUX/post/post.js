...
import { postReseaux } from 'actions/VALDEMARNEActions'

class PostVALDEMARNERESEAUX extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNERESEAUX.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostVALDEMARNERESEAUX))
)
