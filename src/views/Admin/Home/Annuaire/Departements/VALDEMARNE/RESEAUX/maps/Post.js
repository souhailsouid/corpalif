...
import { postReseaux } from 'actions/maps/mapsValdeMarneActions'

class PostVALDEMARNERESEAUXMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNERESEAUXMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postReseaux })(withRouter(PostVALDEMARNERESEAUXMaps))
)
