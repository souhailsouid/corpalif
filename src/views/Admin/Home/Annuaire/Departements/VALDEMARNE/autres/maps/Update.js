...
import { updateStructureAutres, getCurrentStructure_idAutres } from 'actions/maps/mapsValdeMarneActions'
...
class Modal extends React.Component {
	...
	onSubmit(e) {
		...
		window.location.replace('/annuaire/VALDEMARNE/autres')
	}
		...
		return (
			<div>
				<Dialog
					...
					keepMounted
					onClose={() => this.handleClose('searchModal', window.location.replace('/admin/VALDEMARNE/autres'))}
