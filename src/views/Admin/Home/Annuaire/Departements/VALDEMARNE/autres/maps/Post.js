...
import { postAutres } from 'actions/maps/mapsValdeMarneActions'

class PostVALDEMARNEAUTRESMaps extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNEAUTRESMaps.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { postAutres })(withRouter(PostVALDEMARNEAUTRESMaps))
)
