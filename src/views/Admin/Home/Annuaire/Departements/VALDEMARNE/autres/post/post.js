...
import { post_autres } from 'actions/VALDEMARNEActions'

class PostVALDEMARNEautres extends Component {
	constructor(props) {
		super(props)
		this.state = {
...
PostVALDEMARNEautres.propTypes = {
...
export default compose(withStyles(presentationStyle))(
	connect(mapStateTopProps, { post_autres })(withRouter(PostVALDEMARNEautres))
)
