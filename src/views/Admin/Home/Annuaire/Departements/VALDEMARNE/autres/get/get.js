...
import { getCurrentStructure_id_autres, deleteStructure_id_autres } from 'actions/VALDEMARNEActions'
import { connect } from 'react-redux'

class GetVALDEMARNEautres extends Component {
	componentDidMount() {
...
})(withRouter(GetVALDEMARNEautres))
