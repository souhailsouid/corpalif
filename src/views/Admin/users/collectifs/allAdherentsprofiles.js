...
class SectionProfilesCollectif extends React.Component {
	componentDidMount() {
...
SectionProfilesCollectif.propTypes = {
...
export default compose(withStyles(profilePageStyle))(
	connect(mapStateToProps, { getProfiles })(withRouter(SectionProfilesCollectif))
)
