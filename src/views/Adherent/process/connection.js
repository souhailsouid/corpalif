				...
				<div>
					...
					>
						<Card plain className={classes.modalLoginCard}>
							...
							<DialogActions
								className={`${classes.modalFooter} ${classes.justifyContentCenter}`}
								style={{ width: 30, marginBottom: 30, marginLeft: 'auto', marginRight: 'auto' }}
							>
								<ForgotPassword />
							</DialogActions>
						</Card>
...
export default compose(withStyles(javascriptStyles))(connect(mapStateToProps, { processLogin })(withRouter(OpenLogin)))
