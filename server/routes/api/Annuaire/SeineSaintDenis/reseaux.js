...
const Reseaux = require('../../../../models/Annuaire/SeineSaintDenis/reseaux')
// Load User Model
...
// @route   GET api/annuaire/seinesaintdenis/reseaux
// @desc    Get current Annuaire
// @access  Public
router.get('/seinesaintdenis/reseaux', (req, res) => {
	Reseaux.find()
		.then((reseaux) => {
			res.json(reseaux)
		})
...
router.post('/seinesaintdenis/reseaux', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/seinesaintdenis/reseaux/:id
// @desc    Get seinesaintdenis/reseaux by id
// @access  Public
router.get('/seinesaintdenis/reseaux/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/seinesaintdenis/reseaux/:id
// @desc    update post
// @access  Private
router.put('/seinesaintdenis/reseaux/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/seinesaintdenis/reseaux/:id
// @desc    Delete post
// @access  Private
router.delete('/seinesaintdenis/reseaux/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
