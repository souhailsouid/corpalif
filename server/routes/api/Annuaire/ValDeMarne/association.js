...
const Association = require('../../../../models/Annuaire/ValDeMarne/association')
// Load User Model
...
// @route   GET api/annuaire/valdemarne/association
// @desc    Get current Annuaire
// @access  Public
router.get('/valdemarne/association', (req, res) => {
	Association.find()
		.then((association) => {
...
router.post('/valdemarne/association', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/valdemarne/association/:id
// @desc    Get valdemarne/association by id
// @access  Public
router.get('/valdemarne/association/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/valdemarne/association/:id
// @desc    update post
// @access  Private
router.put('/valdemarne/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/valdemarne/association/:id
// @desc    Delete post
// @access  Private
router.delete('/valdemarne/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
