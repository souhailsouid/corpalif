...
const Reseaux = require('../../../../models/Annuaire/ValDeMarne/reseaux')
// Load User Model
...
// @route   GET api/annuaire/valdemarne/reseaux
// @desc    Get current Annuaire
// @access  Public
router.get('/valdemarne/reseaux', (req, res) => {
	Reseaux.find()
		.then((reseaux) => {
			res.json(reseaux)
		})
...
// @route   GET api/annuaire/valdemarne/reseaux/:id
// @desc    Get valdemarne/reseaux by id
// @access  Public
router.get('/valdemarne/reseaux/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/valdemarne/reseaux/:id
// @desc    update post
// @access  Private
router.put('/valdemarne/reseaux/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/valdemarne/reseaux/:id
// @desc    Delete post
// @access  Private
router.delete('/valdemarne/reseaux/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
