...
const Association = require('../../../../models/Annuaire/Yvelines/association')
// Load User Model
...
router.post('/yvelines/association', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/yvelines/association/:id
// @desc    Get yvelines/association by id
// @access  Public
router.get('/yvelines/association/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/yvelines/association/:id
// @desc    update post
// @access  Private
router.put('/yvelines/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/yvelines/association/:id
// @desc    Delete post
// @access  Private
router.delete('/yvelines/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
