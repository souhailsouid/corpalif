...
const Autres = require('../../../../models/Annuaire/Essonne/autres')
// Load User Model
...
// @access  Public
router.get('/essonne/autres', (req, res) => {
	Autres.find()
		.then((autres) => {
			res.json(autres)
		})
...
router.post('/essonne/autres', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @access  Public
router.get('/essonne/autres/:id', (req, res) => {
...
// @desc    update post
// @access  Private
router.put('/essonne/autres/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @desc    Delete post
// @access  Private
router.delete('/essonne/autres/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
