...
const Team = require('../../../../models/Annuaire/Essonne/team')
// Load User Model
...
// @access  Public
router.get('/essonne/team', (req, res) => {
	Team.find()
		.then((team) => {
			res.json(team)
		})
...
router.post('/essonne/team', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @access  Public
router.get('/essonne/team/:id', (req, res) => {
...
// @desc    update post
// @access  Private
router.put('/essonne/team/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @desc    Delete post
// @access  Private
router.delete('/essonne/team/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
