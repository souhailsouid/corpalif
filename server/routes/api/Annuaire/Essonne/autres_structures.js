...
const AutresStructures = require('../../../../models/Annuaire/Essonne/autres_structures')
// Load User Model
...
// @route   GET api/annuaire/essonne/autres_structures
// @desc    Get current Annuaire
// @access  Public
router.get('/essonne/autres_structures', (req, res) => {
...
router.post('/essonne/autres_structures', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/essonne/autres_structures/:id
// @desc    Get essonne/autres_structures by id
// @access  Public
router.get('/essonne/autres_structures/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/essonne/autres_structures/:id
// @desc    update post
// @access  Private
router.put('/essonne/autres_structures/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/essonne/autres_structures/:id
// @desc    Delete post
// @access  Private
router.delete('/essonne/autres_structures/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
