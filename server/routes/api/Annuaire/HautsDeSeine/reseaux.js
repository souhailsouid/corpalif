...
const Reseaux = require('../../../../models/Annuaire/HautsDeSeine/reseaux')
// Load User Model
...
// @route   GET api/annuaire/hautsdeseine/reseaux
// @desc    Get current Annuaire
// @access  Public
router.get('/hautsdeseine/reseaux', (req, res) => {
	Reseaux.find()
		.then((reseaux) => {
			res.json(reseaux)
		})
...
router.post('/hautsdeseine/reseaux', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/hautsdeseine/reseaux/:id
// @desc    Get hautsdeseine/reseaux by id
// @access  Public
router.get('/hautsdeseine/reseaux/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/hautsdeseine/reseaux/:id
// @desc    update post
// @access  Private
router.put('/hautsdeseine/reseaux/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/hautsdeseine/reseaux/:id
// @desc    Delete post
// @access  Private
router.delete('/hautsdeseine/reseaux/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
