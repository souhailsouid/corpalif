...
const Association = require('../../../../models/Annuaire/HautsDeSeine/association')
// Load User Model
...
// @route   GET api/annuaire/hautsdeseine/association
// @desc    Get current Annuaire
// @access  Public
router.get('/hautsdeseine/association', (req, res) => {
	Association.find()
		.then((association) => {
...
router.post('/hautsdeseine/association', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/hautsdeseine/association/:id
// @desc    Get hautsdeseine/association by id
// @access  Public
router.get('/hautsdeseine/association/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/hautsdeseine/association/:id
// @desc    update post
// @access  Private
router.put('/hautsdeseine/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/hautsdeseine/association/:id
// @desc    Delete post
// @access  Private
router.delete('/hautsdeseine/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
