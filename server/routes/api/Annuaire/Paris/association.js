...
const Association = require('../../../../models/Annuaire/Paris/association')
// Load User Model
...
// @route   GET api/annuaire/paris/association
// @desc    Get current Annuaire
// @access  Public
router.get('/paris/association', (req, res) => {
	Association.find()
		.then((association) => {
...
router.post('/paris/association', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/paris/association/:id
// @desc    Get Paris/association by id
// @access  Public
router.get('/paris/association/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/paris/association/:id
// @desc    update post
// @access  Private
router.put('/paris/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/paris/association/:id
// @desc    Delete post
// @access  Private
router.delete('/paris/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
