...
const Reseaux = require('../../../../models/Annuaire/ValDoise/reseaux')
// Load User Model
...
// @route   GET api/annuaire/valdoise/reseaux
// @desc    Get current Annuaire
// @access  Public
router.get('/valdoise/reseaux', (req, res) => {
	Reseaux.find()
		.then((reseaux) => {
			res.json(reseaux)
		})
...
router.post('/valdoise/reseaux', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/valdoise/reseaux/:id
// @desc    Get valdoise/reseaux by id
// @access  Public
router.get('/valdoise/reseaux/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/valdoise/reseaux/:id
// @desc    update post
// @access  Private
router.put('/valdoise/reseaux/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/valdoise/reseaux/:id
// @desc    Delete post
// @access  Private
router.delete('/valdoise/reseaux/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
