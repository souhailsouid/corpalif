...
const Association = require('../../../../models/Annuaire/ValDoise/association')
// Load User Model
...
// @route   GET api/annuaire/valdoise/association
// @desc    Get current Annuaire
// @access  Public
router.get('/valdoise/association', (req, res) => {
	Association.find()
		.then((association) => {
...
router.post('/valdoise/association', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   GET api/annuaire/valdoise/association/:id
// @desc    Get valdoise/association by id
// @access  Public
router.get('/valdoise/association/:id', (req, res) => {
...
// @route   UPDATE api/annuaire/valdoise/association/:id
// @desc    update post
// @access  Private
router.put('/valdoise/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
...
// @route   DELETE api/annuaire/valdoise/association/:id
// @desc    Delete post
// @access  Private
router.delete('/valdoise/association/:id', passport.authenticate('jwt', { session: false }), (req, res) => {
